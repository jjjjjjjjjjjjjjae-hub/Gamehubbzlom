...
.method public static synthetic m(Lkotlinx/coroutines/scheduling/CoroutineScheduler;Ljava/lang/Runnable;Lkotlinx/coroutines/scheduling/h;ZILjava/lang/Object;)V
    .locals 0
    ...
    sget-object p2, Lkotlinx/coroutines/scheduling/k;->g:Lkotlinx/coroutines/scheduling/h;
...
.method public close()V
    ...
    invoke-virtual {p0, v0, v1}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->s(J)V

    return-void
.end method

.method public final d(Lkotlinx/coroutines/scheduling/g;)Z
    .locals 2
    ...
    iget-object p0, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->f:Lkotlinx/coroutines/scheduling/c;
    ...
    :cond_0
    iget-object p0, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->e:Lkotlinx/coroutines/scheduling/c;
...
.method public final e()I
    ...
    :cond_2
    :try_start_3
    invoke-static {}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->c()Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;
...
.method public final f(Ljava/lang/Runnable;Lkotlinx/coroutines/scheduling/h;)Lkotlinx/coroutines/scheduling/g;
    .locals 2

    sget-object p0, Lkotlinx/coroutines/scheduling/k;->f:Lkotlinx/coroutines/scheduling/f;

    invoke-virtual {p0}, Lkotlinx/coroutines/scheduling/f;->a()J

    move-result-wide v0

    instance-of p0, p1, Lkotlinx/coroutines/scheduling/g;
    ...
    iput-object p2, p1, Lkotlinx/coroutines/scheduling/g;->b:Lkotlinx/coroutines/scheduling/h;
    ...
    invoke-direct {p0, p1, v0, v1, p2}, Lkotlinx/coroutines/scheduling/j;-><init>(Ljava/lang/Runnable;JLkotlinx/coroutines/scheduling/h;)V

    return-object p0
.end method

.method public final g()Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;
    .locals 3
...
.method public final h(Ljava/lang/Runnable;Lkotlinx/coroutines/scheduling/h;Z)V
    .locals 5

    invoke-static {}, Lkotlinx/coroutines/c;->a()Lkotlinx/coroutines/b;

    invoke-virtual {p0, p1, p2}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->f(Ljava/lang/Runnable;Lkotlinx/coroutines/scheduling/h;)Lkotlinx/coroutines/scheduling/g;

    move-result-object p1

    iget-object p2, p1, Lkotlinx/coroutines/scheduling/g;->b:Lkotlinx/coroutines/scheduling/h;

    invoke-interface {p2}, Lkotlinx/coroutines/scheduling/h;->b()I
    ...
    :goto_1
    invoke-virtual {p0}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->g()Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;

    move-result-object v4

    invoke-virtual {p0, v4, p1, p3}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->z(Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;Lkotlinx/coroutines/scheduling/g;Z)Lkotlinx/coroutines/scheduling/g;

    move-result-object p1

    if-eqz p1, :cond_3

    invoke-virtual {p0, p1}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->d(Lkotlinx/coroutines/scheduling/g;)Z
    ...
    invoke-virtual {p0, v2, v3, v0}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->t(JZ)V
...
.method public final n(Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;)I
    .locals 0
...
.method public final o()Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;
    ...
    invoke-virtual {p0, v7}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->n(Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;)I
    ...
    sget-object p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->l:Lkotlinx/coroutines/internal/c0;
...
.method public final q(Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;II)V
    ...
    invoke-virtual {p0, p1}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->n(Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;)I
...
.method public final r(Lkotlinx/coroutines/scheduling/g;)V
    .locals 1
...
.method public final s(J)V
    ...
    :cond_1
    iget-object v4, v4, Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;->a:Lkotlinx/coroutines/scheduling/m;

    iget-object v5, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->f:Lkotlinx/coroutines/scheduling/c;

    invoke-virtual {v4, v5}, Lkotlinx/coroutines/scheduling/m;->f(Lkotlinx/coroutines/scheduling/c;)V
    ...
    invoke-virtual {v0, v2}, Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;->g(Z)Lkotlinx/coroutines/scheduling/g;
    ...
    :cond_6
    invoke-virtual {p0, p1}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->r(Lkotlinx/coroutines/scheduling/g;)V
...
.method public toString()Ljava/lang/String;
    ...
    :cond_0
    iget-object v10, v9, Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;->a:Lkotlinx/coroutines/scheduling/m;

    invoke-virtual {v10}, Lkotlinx/coroutines/scheduling/m;->e()I
...
.method public final z(Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;Lkotlinx/coroutines/scheduling/g;Z)Lkotlinx/coroutines/scheduling/g;
    .locals 1
    ...
    :cond_1
    iget-object p0, p2, Lkotlinx/coroutines/scheduling/g;->b:Lkotlinx/coroutines/scheduling/h;

    invoke-interface {p0}, Lkotlinx/coroutines/scheduling/h;->b()I
    ...
    iget-object p0, p1, Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;->a:Lkotlinx/coroutines/scheduling/m;

    invoke-virtual {p0, p2, p3}, Lkotlinx/coroutines/scheduling/m;->a(Lkotlinx/coroutines/scheduling/g;Z)Lkotlinx/coroutines/scheduling/g;
