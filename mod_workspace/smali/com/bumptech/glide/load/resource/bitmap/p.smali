...
.field public static volatile j:Lcom/bumptech/glide/load/resource/bitmap/p;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/bumptech/glide/load/resource/bitmap/p;->g:Z

    const/4 v0, 0x1

    sput-boolean v0, Lcom/bumptech/glide/load/resource/bitmap/p;->h:Z
    ...
    sput-object v0, Lcom/bumptech/glide/load/resource/bitmap/p;->i:Ljava/io/File;

    const/4 v0, -0x1

    sput v0, Lcom/bumptech/glide/load/resource/bitmap/p;->k:I
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/p;->f:Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-static {}, Lcom/bumptech/glide/load/resource/bitmap/p;->f()Z
    ...
    iput v1, p0, Lcom/bumptech/glide/load/resource/bitmap/p;->c:I
...
.method public static b()Lcom/bumptech/glide/load/resource/bitmap/p;
    ...
    sget-object v0, Lcom/bumptech/glide/load/resource/bitmap/p;->j:Lcom/bumptech/glide/load/resource/bitmap/p;
    ...
    :try_start_0
    sget-object v1, Lcom/bumptech/glide/load/resource/bitmap/p;->j:Lcom/bumptech/glide/load/resource/bitmap/p;
    ...
    sput-object v1, Lcom/bumptech/glide/load/resource/bitmap/p;->j:Lcom/bumptech/glide/load/resource/bitmap/p;
...
.method public static f()Z
    ...
    invoke-static {}, Lcom/bumptech/glide/load/resource/bitmap/p;->g()Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {}, Lcom/bumptech/glide/load/resource/bitmap/p;->h()Z
...
.method public final a()Z
    ...
    iget-object p0, p0, Lcom/bumptech/glide/load/resource/bitmap/p;->f:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final c()I
    ...
    sget v0, Lcom/bumptech/glide/load/resource/bitmap/p;->k:I

    const/4 v1, -0x1

    if-eq v0, v1, :cond_0

    sget p0, Lcom/bumptech/glide/load/resource/bitmap/p;->k:I

    goto :goto_0

    :cond_0
    iget p0, p0, Lcom/bumptech/glide/load/resource/bitmap/p;->b:I
...
.method public final declared-synchronized d()Z
    ...
    sget-object v2, Lcom/bumptech/glide/load/resource/bitmap/p;->i:Ljava/io/File;
    ...
    invoke-virtual {p0}, Lcom/bumptech/glide/load/resource/bitmap/p;->c()I
...
.method public e(IIZZ)Z
    ...
    :cond_3
    sget-boolean p3, Lcom/bumptech/glide/load/resource/bitmap/p;->h:Z
    ...
    :cond_5
    invoke-virtual {p0}, Lcom/bumptech/glide/load/resource/bitmap/p;->a()Z
    ...
    :cond_d
    invoke-virtual {p0}, Lcom/bumptech/glide/load/resource/bitmap/p;->d()Z
...
.method public i(IILandroid/graphics/BitmapFactory$Options;ZZ)Z
    ...
    invoke-virtual {p0, p1, p2, p4, p5}, Lcom/bumptech/glide/load/resource/bitmap/p;->e(IIZZ)Z
