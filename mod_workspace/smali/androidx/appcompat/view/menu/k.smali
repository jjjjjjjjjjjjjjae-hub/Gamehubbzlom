...
.field public final q:Landroid/widget/PopupWindow$OnDismissListener;
...
.method public constructor <init>(Landroid/content/Context;Landroidx/appcompat/view/menu/f;Landroid/view/View;ZII)V
    ...
    .line 6
    iput v0, p0, Landroidx/appcompat/view/menu/k;->p:I
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/k;->q:Landroid/widget/PopupWindow$OnDismissListener;
...
.method public final a()Landroidx/appcompat/view/menu/j;
    ...
    sget v1, Landroidx/appcompat/f;->abc_cascading_menus_min_smallest_width:I
    ...
    :cond_0
    iget v1, p0, Landroidx/appcompat/view/menu/k;->p:I

    const/4 v2, -0x1

    if-eq v1, v2, :cond_1

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/q;->D(I)V
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/k;->q:Landroid/widget/PopupWindow$OnDismissListener;
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/j;->q(Landroid/view/View;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/k;->i:Landroidx/appcompat/view/menu/l$a;

    invoke-interface {v0, v1}, Landroidx/appcompat/view/menu/l;->e(Landroidx/appcompat/view/menu/l$a;)V
...
.method public m(Landroidx/appcompat/view/menu/l$a;)V
    ...
    invoke-interface {p0, p1}, Landroidx/appcompat/view/menu/l;->e(Landroidx/appcompat/view/menu/l$a;)V
...
.method public final p(IIZZ)V
    ...
    invoke-static {p3}, Landroidx/core/view/t0;->v(Landroid/view/View;)I
    ...
    sget v1, Landroidx/appcompat/f;->sesl_menu_popup_offset_horizontal:I
