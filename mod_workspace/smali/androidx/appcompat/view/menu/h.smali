...
.method public B(I)Landroidx/appcompat/view/menu/h;
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/view/menu/f;->N(Z)V

    return-object p0
.end method

.method public C(I)Landroidx/core/internal/view/b;
    .locals 0
...
.method public D(Landroidx/appcompat/view/menu/r;)V
    .locals 0
...
.method public G()Z
    ...
    invoke-virtual {p0}, Landroidx/appcompat/view/menu/h;->k()C
...
.method public bridge synthetic c(I)Landroid/view/MenuItem;
    .locals 0

    invoke-virtual {p0, p1}, Landroidx/appcompat/view/menu/h;->B(I)Landroidx/appcompat/view/menu/h;
...
.method public d()Landroidx/core/view/b;
    .locals 0
...
.method public e(Landroidx/core/view/b;)Landroidx/core/internal/view/b;
    .locals 1
...
.method public f()V
    ...
    invoke-virtual {v0, p0}, Landroidx/appcompat/view/menu/f;->L(Landroidx/appcompat/view/menu/h;)V
...
.method public getIcon()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v0}, Landroidx/appcompat/view/menu/h;->h(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method public final h(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    .locals 1
...
.method public l()Ljava/lang/String;
    ...
    sget v3, Landroidx/appcompat/k;->abc_prepend_shortcut_label:I
    ...
    invoke-virtual {v3}, Landroidx/appcompat/view/menu/f;->J()Z
    ...
    :goto_0
    sget v3, Landroidx/appcompat/k;->abc_menu_meta_shortcut_label:I
    ...
    invoke-static {v2, p0, v4, v3}, Landroidx/appcompat/view/menu/h;->g(Ljava/lang/StringBuilder;IILjava/lang/String;)V

    sget v3, Landroidx/appcompat/k;->abc_menu_ctrl_shortcut_label:I
    ...
    sget v3, Landroidx/appcompat/k;->abc_menu_alt_shortcut_label:I
    ...
    sget v3, Landroidx/appcompat/k;->abc_menu_shift_shortcut_label:I
    ...
    sget v3, Landroidx/appcompat/k;->abc_menu_sym_shortcut_label:I
    ...
    sget v3, Landroidx/appcompat/k;->abc_menu_function_shortcut_label:I
    ...
    :cond_3
    sget p0, Landroidx/appcompat/k;->abc_menu_space_shortcut_label:I
    ...
    :cond_4
    sget p0, Landroidx/appcompat/k;->abc_menu_enter_shortcut_label:I
    ...
    :cond_5
    sget p0, Landroidx/appcompat/k;->abc_menu_delete_shortcut_label:I
...
.method public m(Landroidx/appcompat/view/menu/m$a;)Ljava/lang/CharSequence;
    .locals 0

    if-eqz p1, :cond_0

    invoke-interface {p1}, Landroidx/appcompat/view/menu/m$a;->e()Z
...
.method public bridge synthetic setActionView(I)Landroid/view/MenuItem;
    ...
    .line 1
    invoke-virtual {p0, p1}, Landroidx/appcompat/view/menu/h;->u(I)Landroidx/core/internal/view/b;
...
.method public bridge synthetic setActionView(Landroid/view/View;)Landroid/view/MenuItem;
    ...
    .line 2
    invoke-virtual {p0, p1}, Landroidx/appcompat/view/menu/h;->v(Landroid/view/View;)Landroidx/core/internal/view/b;
...
.method public setAlphabeticShortcut(CI)Landroid/view/MenuItem;
    ...
    invoke-virtual {p1, p2}, Landroidx/appcompat/view/menu/f;->N(Z)V
...
.method public setChecked(Z)Landroid/view/MenuItem;
    ...
    invoke-virtual {p1, p0}, Landroidx/appcompat/view/menu/f;->Y(Landroid/view/MenuItem;)V

    goto :goto_0

    :cond_0
    invoke-virtual {p0, p1}, Landroidx/appcompat/view/menu/h;->x(Z)V
...
.method public bridge synthetic setShowAsActionFlags(I)Landroid/view/MenuItem;
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/view/menu/h;->C(I)Landroidx/core/internal/view/b;
...
.method public setTitle(Ljava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/f;->N(Z)V
...
.method public setVisible(Z)Landroid/view/MenuItem;
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/view/menu/h;->E(Z)Z
    ...
    invoke-virtual {p1, p0}, Landroidx/appcompat/view/menu/f;->M(Landroidx/appcompat/view/menu/h;)V
...
.method public t()Z
    ...
    invoke-virtual {p0}, Landroidx/appcompat/view/menu/h;->s()Z

    move-result v0

    if-nez v0, :cond_0

    invoke-virtual {p0}, Landroidx/appcompat/view/menu/h;->r()Z
...
.method public u(I)Landroidx/core/internal/view/b;
    .locals 3
...
.method public v(Landroid/view/View;)Landroidx/core/internal/view/b;
    .locals 2
...
.method public x(Z)V
    ...
    invoke-virtual {p0, v2}, Landroidx/appcompat/view/menu/f;->N(Z)V
