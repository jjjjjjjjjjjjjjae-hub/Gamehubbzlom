...
.method public constructor <init>(Landroidx/appcompat/app/k;Landroid/view/Window$Callback;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/app/k$n;->f:Landroidx/appcompat/app/k;
...
.method public b(Landroid/view/Window$Callback;Landroid/view/KeyEvent;)Z
    ...
    :try_start_0
    iput-boolean v0, p0, Landroidx/appcompat/app/k$n;->d:Z
    ...
    iput-boolean v1, p0, Landroidx/appcompat/app/k$n;->d:Z
...
.method public c(Landroid/view/Window$Callback;)V
    ...
    :try_start_0
    iput-boolean v0, p0, Landroidx/appcompat/app/k$n;->c:Z

    invoke-interface {p1}, Landroid/view/Window$Callback;->onContentChanged()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iput-boolean v1, p0, Landroidx/appcompat/app/k$n;->c:Z
...
.method public d(Landroid/view/Window$Callback;ILandroid/view/Menu;)V
    ...
    :try_start_0
    iput-boolean v0, p0, Landroidx/appcompat/app/k$n;->e:Z

    invoke-interface {p1, p2, p3}, Landroid/view/Window$Callback;->onPanelClosed(ILandroid/view/Menu;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iput-boolean v1, p0, Landroidx/appcompat/app/k$n;->e:Z
...
.method public dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    iget-boolean v0, p0, Landroidx/appcompat/app/k$n;->d:Z
    ...
    :cond_0
    iget-object v0, p0, Landroidx/appcompat/app/k$n;->f:Landroidx/appcompat/app/k;

    invoke-virtual {v0, p1}, Landroidx/appcompat/app/k;->k0(Landroid/view/KeyEvent;)Z
...
.method public dispatchKeyShortcutEvent(Landroid/view/KeyEvent;)Z
    ...
    iget-object p0, p0, Landroidx/appcompat/app/k$n;->f:Landroidx/appcompat/app/k;

    invoke-virtual {p1}, Landroid/view/KeyEvent;->getKeyCode()I

    move-result v0

    invoke-virtual {p0, v0, p1}, Landroidx/appcompat/app/k;->J0(ILandroid/view/KeyEvent;)Z
...
.method public e(Landroidx/appcompat/app/k$g;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/app/k$n;->b:Landroidx/appcompat/app/k$g;
...
.method public final f(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
    ...
    iget-object v1, p0, Landroidx/appcompat/app/k$n;->f:Landroidx/appcompat/app/k;

    iget-object v1, v1, Landroidx/appcompat/app/k;->k:Landroid/content/Context;

    invoke-direct {v0, v1, p1}, Landroidx/appcompat/view/f$a;-><init>(Landroid/content/Context;Landroid/view/ActionMode$Callback;)V

    iget-object p0, p0, Landroidx/appcompat/app/k$n;->f:Landroidx/appcompat/app/k;

    invoke-virtual {p0, v0}, Landroidx/appcompat/app/k;->R(Landroidx/appcompat/view/b$a;)Landroidx/appcompat/view/b;
...
.method public onContentChanged()V
    ...
    iget-boolean v0, p0, Landroidx/appcompat/app/k$n;->c:Z
...
.method public onCreatePanelView(I)Landroid/view/View;
    ...
    iget-object v0, p0, Landroidx/appcompat/app/k$n;->b:Landroidx/appcompat/app/k$g;
...
.method public onMenuOpened(ILandroid/view/Menu;)Z
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/app/k;->M0(I)V
...
.method public onPanelClosed(ILandroid/view/Menu;)V
    ...
    iget-boolean v0, p0, Landroidx/appcompat/app/k$n;->e:Z
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/app/k;->N0(I)V
...
.method public onPreparePanel(ILandroid/view/View;Landroid/view/Menu;)Z
    ...
    :cond_2
    iget-object v3, p0, Landroidx/appcompat/app/k$n;->b:Landroidx/appcompat/app/k$g;
...
.method public onProvideKeyboardShortcuts(Ljava/util/List;Landroid/view/Menu;I)V
    ...
    invoke-virtual {v0, v1, v2}, Landroidx/appcompat/app/k;->w0(IZ)Landroidx/appcompat/app/k$s;
...
.method public onWindowStartingActionMode(Landroid/view/ActionMode$Callback;I)Landroid/view/ActionMode;
    ...
    invoke-virtual {v0}, Landroidx/appcompat/app/k;->E0()Z
    ...
    .line 3
    :cond_0
    invoke-virtual {p0, p1}, Landroidx/appcompat/app/k$n;->f(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
