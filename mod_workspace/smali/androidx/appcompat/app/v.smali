...
.method public final b()Landroid/location/Location;
    ...
    invoke-static {v0, v1}, Landroidx/core/content/d;->c(Landroid/content/Context;Ljava/lang/String;)I
    ...
    invoke-virtual {p0, v0}, Landroidx/appcompat/app/v;->c(Ljava/lang/String;)Landroid/location/Location;
    ...
    invoke-static {v2, v3}, Landroidx/core/content/d;->c(Landroid/content/Context;Ljava/lang/String;)I
    ...
    invoke-virtual {p0, v1}, Landroidx/appcompat/app/v;->c(Ljava/lang/String;)Landroid/location/Location;
...
.method public final c(Ljava/lang/String;)Landroid/location/Location;
    ...
    iget-object p0, p0, Landroidx/appcompat/app/v;->b:Landroid/location/LocationManager;
...
.method public d()Z
    ...
    invoke-virtual {p0}, Landroidx/appcompat/app/v;->e()Z

    move-result v1

    if-eqz v1, :cond_0

    iget-boolean p0, v0, Landroidx/appcompat/app/v$a;->a:Z

    return p0

    :cond_0
    invoke-virtual {p0}, Landroidx/appcompat/app/v;->b()Landroid/location/Location;

    move-result-object v1

    if-eqz v1, :cond_1

    invoke-virtual {p0, v1}, Landroidx/appcompat/app/v;->f(Landroid/location/Location;)V
...
.method public final e()Z
    ...
    iget-object p0, p0, Landroidx/appcompat/app/v;->c:Landroidx/appcompat/app/v$a;

    if-eqz p0, :cond_0

    iget-wide v0, p0, Landroidx/appcompat/app/v$a;->b:J
...
.method public final f(Landroid/location/Location;)V
    ...
    iget-object v0, v0, Landroidx/appcompat/app/v;->c:Landroidx/appcompat/app/v$a;
    ...
    invoke-virtual/range {v1 .. v7}, Landroidx/appcompat/app/u;->a(JDD)V
    ...
    iget v1, v10, Landroidx/appcompat/app/u;->c:I
    ...
    :goto_1
    iget-wide v14, v10, Landroidx/appcompat/app/u;->b:J

    iget-wide v6, v10, Landroidx/appcompat/app/u;->a:J
    ...
    iget-wide v1, v10, Landroidx/appcompat/app/u;->b:J
    ...
    :goto_4
    iput-boolean v13, v0, Landroidx/appcompat/app/v$a;->a:Z

    iput-wide v14, v0, Landroidx/appcompat/app/v$a;->b:J
