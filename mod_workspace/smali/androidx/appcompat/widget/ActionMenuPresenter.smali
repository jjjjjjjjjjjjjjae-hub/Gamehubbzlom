...
.field public final V:Landroidx/appcompat/widget/ActionMenuPresenter$h;
...
.field public k:Landroidx/appcompat/widget/ActionMenuPresenter$e;
...
.field public y:Landroidx/appcompat/widget/ActionMenuPresenter$f;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->V:Landroidx/appcompat/widget/ActionMenuPresenter$h;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->a0:Ljava/text/NumberFormat;

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object p1

    sget v0, Landroidx/appcompat/d;->sesl_action_bar_text_item_mode:I
...
.method public static synthetic A(Landroidx/appcompat/widget/ActionMenuPresenter;)Z
    .locals 0

    iget-boolean p0, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->X:Z

    return p0
.end method

.method public static synthetic B(Landroidx/appcompat/widget/ActionMenuPresenter;Z)Z
    .locals 0
...
.method public static synthetic C(Landroidx/appcompat/widget/ActionMenuPresenter;)Landroidx/appcompat/view/menu/f;
    .locals 0
...
.method public static synthetic D(Landroidx/appcompat/widget/ActionMenuPresenter;)Landroidx/appcompat/view/menu/f;
    .locals 0
...
.method public static synthetic E(Landroidx/appcompat/widget/ActionMenuPresenter;)Landroidx/appcompat/view/menu/m;
    .locals 0
...
.method public static synthetic F(Landroidx/appcompat/widget/ActionMenuPresenter;)Landroidx/appcompat/view/menu/f;
    .locals 0
...
.method public static synthetic G(Landroidx/appcompat/widget/ActionMenuPresenter;)Landroidx/appcompat/view/menu/f;
    .locals 0
...
.method public static synthetic t(Landroidx/appcompat/widget/ActionMenuPresenter;)Z
    .locals 0

    iget-boolean p0, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->Y:Z

    return p0
.end method

.method public static synthetic u(Landroidx/appcompat/widget/ActionMenuPresenter;)Ljava/text/NumberFormat;
    .locals 0

    iget-object p0, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->a0:Ljava/text/NumberFormat;

    return-object p0
.end method

.method public static synthetic v(Landroidx/appcompat/widget/ActionMenuPresenter;)Landroidx/appcompat/view/menu/f;
    .locals 0
...
.method public static synthetic w(Landroidx/appcompat/widget/ActionMenuPresenter;)Landroidx/appcompat/view/menu/m;
    .locals 0
...
.method public static synthetic x(Landroidx/appcompat/widget/ActionMenuPresenter;)Ljava/lang/CharSequence;
    .locals 0

    iget-object p0, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->Z:Ljava/lang/CharSequence;

    return-object p0
.end method

.method public static synthetic y(Landroidx/appcompat/widget/ActionMenuPresenter;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->Z:Ljava/lang/CharSequence;

    return-object p1
.end method

.method public static synthetic z(Landroidx/appcompat/widget/ActionMenuPresenter;)Landroid/content/Context;
    .locals 0
...
.method public K()Z
    ...
    :cond_0
    iget-object p0, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->y:Landroidx/appcompat/widget/ActionMenuPresenter$f;
...
.method public O(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/view/menu/f;->N(Z)V
...
.method public c(Landroidx/appcompat/view/menu/h;Landroidx/appcompat/view/menu/m$a;)V
    ...
    :cond_0
    iget-object p0, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->U:Landroidx/appcompat/widget/ActionMenuPresenter$b;
...
.method public f(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/ActionMenuPresenter;->g(Landroidx/appcompat/view/menu/r;)Z
...
.method public g(Landroidx/appcompat/view/menu/r;)Z
    ...
    :goto_0
    invoke-virtual {v1}, Landroidx/appcompat/view/menu/r;->j0()Landroid/view/Menu;
    ...
    invoke-virtual {p0, v1}, Landroidx/appcompat/widget/ActionMenuPresenter;->I(Landroid/view/MenuItem;)Landroid/view/View;
    ...
    iput v2, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->W:I
...
.method public h()Landroid/os/Parcelable;
    ...
    iget p0, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->W:I
...
.method public i(Z)V
    ...
    invoke-virtual {v3}, Landroidx/appcompat/view/menu/h;->d()Landroidx/core/view/b;
    ...
    sget v0, Landroidx/appcompat/h;->sesl_action_bar_overflow_button:I
...
.method public j()Z
    ...
    invoke-virtual {v14}, Landroidx/appcompat/view/menu/h;->s()Z
    ...
    :cond_2
    invoke-virtual {v14}, Landroidx/appcompat/view/menu/h;->r()Z
    ...
    invoke-virtual {v15}, Landroidx/appcompat/view/menu/h;->s()Z

    move-result v16

    if-eqz v16, :cond_c

    invoke-virtual {v0, v15, v2, v8}, Landroidx/appcompat/widget/ActionMenuPresenter;->p(Landroidx/appcompat/view/menu/h;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    :cond_b
    invoke-virtual {v15, v13}, Landroidx/appcompat/view/menu/h;->z(Z)V
    ...
    :cond_c
    invoke-virtual {v15}, Landroidx/appcompat/view/menu/h;->r()Z
    ...
    invoke-virtual {v0, v15, v3, v8}, Landroidx/appcompat/widget/ActionMenuPresenter;->p(Landroidx/appcompat/view/menu/h;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {v13}, Landroidx/appcompat/view/menu/h;->p()Z
    ...
    invoke-virtual {v13, v0}, Landroidx/appcompat/view/menu/h;->z(Z)V
    ...
    :cond_19
    invoke-virtual {v15, v3}, Landroidx/appcompat/view/menu/h;->z(Z)V
    ...
    invoke-virtual {v15, v0}, Landroidx/appcompat/view/menu/h;->z(Z)V
...
.method public l(Landroid/content/Context;Landroidx/appcompat/view/menu/f;)V
    ...
    sget v2, Landroidx/appcompat/h;->sesl_action_bar_overflow_button:I
    ...
    invoke-virtual {v0, v3}, Landroidx/appcompat/widget/p;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
