...
.field public c:Landroidx/collection/l;
...
.method public static declared-synchronized k(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-virtual {v1, p0, p1}, Landroidx/appcompat/widget/m0$a;->k(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-virtual {v1, p0, p1, v2}, Landroidx/appcompat/widget/m0$a;->l(ILandroid/graphics/PorterDuff$Mode;Landroid/graphics/PorterDuffColorFilter;)Landroid/graphics/PorterDuffColorFilter;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static v(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/z0;[I)V
    .locals 2
...
.method public final declared-synchronized a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-virtual {v0, p2, p3, p1}, Landroidx/collection/h;->i(JLjava/lang/Object;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final b(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/m0;->a:Ljava/util/WeakHashMap;

    invoke-virtual {p0, p1, v0}, Ljava/util/WeakHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_1
    invoke-virtual {v0, p2, p3}, Landroidx/collection/l;->a(ILjava/lang/Object;)V
...
.method public final c(Landroid/content/Context;)V
    ...
    sget v0, Landroidx/appcompat/resources/a;->abc_vector_test:I
...
.method public final e(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    invoke-interface {v3, p0, p1, p2}, Landroidx/appcompat/widget/m0$c;->a(Landroidx/appcompat/widget/m0;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public final declared-synchronized h(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    :try_start_1
    invoke-virtual {v0, p2, p3}, Landroidx/collection/h;->e(J)Ljava/lang/Object;
    ...
    :cond_1
    :try_start_2
    invoke-virtual {v0, p2, p3}, Landroidx/collection/h;->j(J)V
    :try_end_2
...
.method public declared-synchronized l(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :cond_0
    invoke-interface {v0, p1, p2}, Landroidx/appcompat/widget/m0$c;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public final m(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    check-cast p0, Landroidx/collection/l;

    if-eqz p0, :cond_0

    invoke-virtual {p0, p2}, Landroidx/collection/l;->f(I)Ljava/lang/Object;
...
.method public n(I)Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/m0;->g:Landroidx/appcompat/widget/m0$c;
    ...
    :cond_0
    invoke-interface {p0, p1}, Landroidx/appcompat/widget/m0$c;->d(I)Landroid/graphics/PorterDuff$Mode;
...
.method public final q(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/m0;->b:Landroidx/collection/k;

    const/4 v1, 0x0

    if-eqz v0, :cond_a

    invoke-virtual {v0}, Landroidx/collection/k;->isEmpty()Z

    move-result v0

    if-nez v0, :cond_a

    iget-object v0, p0, Landroidx/appcompat/widget/m0;->c:Landroidx/collection/l;

    const-string v2, "appcompat_skip_skip"

    if-eqz v0, :cond_1

    invoke-virtual {v0, p2}, Landroidx/collection/l;->f(I)Ljava/lang/Object;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/m0;->b:Landroidx/collection/k;

    invoke-virtual {v3, v0}, Landroidx/collection/k;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/m0;->c:Landroidx/collection/l;
    ...
    iget-object v8, p0, Landroidx/appcompat/widget/m0;->c:Landroidx/collection/l;

    invoke-virtual {v8, p2, v3}, Landroidx/collection/l;->a(ILjava/lang/Object;)V

    iget-object v8, p0, Landroidx/appcompat/widget/m0;->b:Landroidx/collection/k;

    invoke-virtual {v8, v3}, Landroidx/collection/k;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/m0;->c:Landroidx/collection/l;

    invoke-virtual {p0, p2, v2}, Landroidx/collection/l;->a(ILjava/lang/Object;)V
...
.method public declared-synchronized s(Landroid/content/Context;Landroidx/appcompat/widget/o1;I)Landroid/graphics/drawable/Drawable;
    .locals 1
...
.method public w(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-interface {p0, p1, p2, p3}, Landroidx/appcompat/widget/m0$c;->c(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
