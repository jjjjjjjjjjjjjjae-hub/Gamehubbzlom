...
.field public k:Landroidx/appcompat/widget/i0;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 1
    sget v0, Landroidx/appcompat/c;->spinnerStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    invoke-static {p0, v1}, Landroidx/appcompat/widget/x0;->a(Landroid/view/View;Landroid/content/Context;)V

    .line 8
    sget-object v1, Landroidx/appcompat/m;->Spinner:[I

    invoke-static {p1, p2, v1, p3, v0}, Landroidx/appcompat/widget/b1;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/b1;
    ...
    .line 11
    :cond_0
    sget p5, Landroidx/appcompat/m;->Spinner_popupTheme:I

    invoke-virtual {v1, p5, v0}, Landroidx/appcompat/widget/b1;->n(II)I
    ...
    sget-object v4, Landroidx/appcompat/m;->Spinner:[I

    invoke-static {v3, p2, v4, p3, v0}, Landroidx/appcompat/widget/b1;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/b1;

    move-result-object v0

    .line 23
    sget v3, Landroidx/appcompat/m;->Spinner_android_dropDownWidth:I

    const/4 v4, -0x2

    invoke-virtual {v0, v3, v4}, Landroidx/appcompat/widget/b1;->m(II)I
    ...
    .line 24
    invoke-virtual {p4}, Landroidx/appcompat/widget/i0;->h()I
    ...
    .line 25
    sget v3, Landroidx/appcompat/m;->Spinner_android_prompt:I

    invoke-virtual {v1, v3}, Landroidx/appcompat/widget/b1;->o(I)Ljava/lang/String;

    move-result-object v3

    invoke-virtual {p4, v3}, Landroidx/appcompat/widget/AppCompatSpinner$f;->l(Ljava/lang/CharSequence;)V
    ...
    .line 28
    iput-object p4, p0, Landroidx/appcompat/widget/AppCompatSpinner;->k:Landroidx/appcompat/widget/i0;

    .line 29
    new-instance v0, Landroidx/appcompat/widget/AppCompatSpinner$a;

    invoke-direct {v0, p0, p0, p4}, Landroidx/appcompat/widget/AppCompatSpinner$a;-><init>(Landroidx/appcompat/widget/AppCompatSpinner;Landroid/view/View;Landroidx/appcompat/widget/AppCompatSpinner$f;)V

    iput-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->c:Landroidx/appcompat/widget/g0;
    ...
    .line 31
    sget v0, Landroidx/appcompat/m;->Spinner_android_prompt:I

    invoke-virtual {v1, v0}, Landroidx/appcompat/widget/b1;->o(I)Ljava/lang/String;

    move-result-object v0

    invoke-interface {p4, v0}, Landroidx/appcompat/widget/AppCompatSpinner$g;->l(Ljava/lang/CharSequence;)V

    .line 32
    :goto_5
    sget p4, Landroidx/appcompat/m;->Spinner_android_entries:I

    invoke-virtual {v1, p4}, Landroidx/appcompat/widget/b1;->q(I)[Ljava/lang/CharSequence;
    ...
    .line 34
    sget p1, Landroidx/appcompat/j;->support_simple_spinner_dropdown_item:I
    ...
    .line 41
    :cond_8
    iget-object p0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->a:Landroidx/appcompat/widget/d;
...
.method public c()V
    ...
    invoke-interface {v0, v1, p0}, Landroidx/appcompat/widget/AppCompatSpinner$g;->o(II)V
...
.method public getDropDownHorizontalOffset()I
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/AppCompatSpinner$g;->h()I
...
.method public getDropDownVerticalOffset()I
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/AppCompatSpinner$g;->p()I
...
.method public getPopupBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/AppCompatSpinner$g;->k()Landroid/graphics/drawable/Drawable;
...
.method public getPrompt()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/AppCompatSpinner$g;->j()Ljava/lang/CharSequence;
...
.method public onAttachedToWindow()V
    ...
    iput-boolean v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->n:Z
...
.method public onDetachedFromWindow()V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->l:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/AppCompatSpinner;->l:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;

    invoke-virtual {v0, v2}, Landroid/view/ViewTreeObserver;->removeOnGlobalLayoutListener(Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;)V

    iput-object v1, p0, Landroidx/appcompat/widget/AppCompatSpinner;->l:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;

    :cond_1
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->m:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/AppCompatSpinner;->m:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;

    invoke-virtual {v0, v2}, Landroid/view/ViewTreeObserver;->removeOnGlobalLayoutListener(Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;)V

    iput-object v1, p0, Landroidx/appcompat/widget/AppCompatSpinner;->m:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-interface {p0}, Landroidx/appcompat/widget/AppCompatSpinner$g;->a()Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->c:Landroidx/appcompat/widget/g0;
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    invoke-direct {v1, p1, v0}, Landroidx/appcompat/widget/AppCompatSpinner$e;-><init>(Landroid/widget/SpinnerAdapter;Landroid/content/res/Resources$Theme;)V

    invoke-interface {p0, v1}, Landroidx/appcompat/widget/AppCompatSpinner$g;->q(Landroid/widget/ListAdapter;)V
...
.method public setDropDownHorizontalOffset(I)V
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/AppCompatSpinner$g;->n(I)V

    iget-object p0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->f:Landroidx/appcompat/widget/AppCompatSpinner$g;

    invoke-interface {p0, p1}, Landroidx/appcompat/widget/AppCompatSpinner$g;->i(I)V
...
.method public setDropDownVerticalOffset(I)V
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/AppCompatSpinner$g;->m(I)V
...
.method public setPopupBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/AppCompatSpinner$g;->g(Landroid/graphics/drawable/Drawable;)V
...
.method public setPrompt(Ljava/lang/CharSequence;)V
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/AppCompatSpinner$g;->l(Ljava/lang/CharSequence;)V
