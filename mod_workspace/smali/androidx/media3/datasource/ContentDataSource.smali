...
.method public m(Landroidx/media3/datasource/g;)J
    ...
    :try_start_0
    iget-object v3, v1, Landroidx/media3/datasource/g;->a:Landroid/net/Uri;

    invoke-virtual {v3}, Landroid/net/Uri;->normalizeScheme()Landroid/net/Uri;

    move-result-object v3

    iput-object v3, v0, Landroidx/media3/datasource/ContentDataSource;->f:Landroid/net/Uri;

    invoke-virtual/range {p0 .. p1}, Landroidx/media3/datasource/a;->s(Landroidx/media3/datasource/g;)V
    ...
    iget-object v6, v0, Landroidx/media3/datasource/ContentDataSource;->e:Landroid/content/ContentResolver;
    ...
    :cond_0
    iget-object v4, v0, Landroidx/media3/datasource/ContentDataSource;->e:Landroid/content/ContentResolver;
    ...
    :goto_0
    iput-object v4, v0, Landroidx/media3/datasource/ContentDataSource;->g:Landroid/content/res/AssetFileDescriptor;
    ...
    iput-object v3, v0, Landroidx/media3/datasource/ContentDataSource;->h:Ljava/io/FileInputStream;
    ...
    iget-wide v13, v1, Landroidx/media3/datasource/g;->g:J
    ...
    iget-wide v5, v1, Landroidx/media3/datasource/g;->g:J
    ...
    iput-wide v8, v0, Landroidx/media3/datasource/ContentDataSource;->i:J
    ...
    iput-wide v5, v0, Landroidx/media3/datasource/ContentDataSource;->i:J
    ...
    iput-wide v6, v0, Landroidx/media3/datasource/ContentDataSource;->i:J
    :try_end_0
    ...
    :goto_2
    iget-wide v2, v1, Landroidx/media3/datasource/g;->h:J

    cmp-long v5, v2, v8

    if-eqz v5, :cond_7

    iget-wide v5, v0, Landroidx/media3/datasource/ContentDataSource;->i:J
    ...
    :goto_3
    iput-wide v2, v0, Landroidx/media3/datasource/ContentDataSource;->i:J

    :cond_7
    const/4 v2, 0x1

    iput-boolean v2, v0, Landroidx/media3/datasource/ContentDataSource;->j:Z

    invoke-virtual/range {p0 .. p1}, Landroidx/media3/datasource/a;->t(Landroidx/media3/datasource/g;)V

    iget-wide v1, v1, Landroidx/media3/datasource/g;->h:J
    ...
    :cond_8
    iget-wide v1, v0, Landroidx/media3/datasource/ContentDataSource;->i:J
...
.method public o()Landroid/net/Uri;
    ...
    iget-object p0, p0, Landroidx/media3/datasource/ContentDataSource;->f:Landroid/net/Uri;
