...
.method public final a(Landroid/os/Message;Landroidx/media3/exoplayer/drm/MediaDrmCallbackException;)Z
    ...
    invoke-static {v7}, Landroidx/media3/exoplayer/drm/DefaultDrmSession;->p(Landroidx/media3/exoplayer/drm/DefaultDrmSession;)Landroidx/media3/exoplayer/upstream/i;

    move-result-object v7

    const/4 v8, 0x3

    invoke-interface {v7, v8}, Landroidx/media3/exoplayer/upstream/i;->b(I)I
    ...
    iget-object v12, v2, Landroidx/media3/exoplayer/drm/MediaDrmCallbackException;->a:Landroidx/media3/datasource/g;

    iget-object v13, v2, Landroidx/media3/exoplayer/drm/MediaDrmCallbackException;->b:Landroid/net/Uri;

    iget-object v14, v2, Landroidx/media3/exoplayer/drm/MediaDrmCallbackException;->c:Ljava/util/Map;
    ...
    invoke-direct/range {v9 .. v20}, Landroidx/media3/exoplayer/source/w;-><init>(JLandroidx/media3/datasource/g;Landroid/net/Uri;Ljava/util/Map;JJJ)V

    new-instance v6, Landroidx/media3/exoplayer/source/z;

    invoke-direct {v6, v8}, Landroidx/media3/exoplayer/source/z;-><init>(I)V
    ...
    new-instance v8, Landroidx/media3/exoplayer/upstream/i$a;

    iget v3, v3, Landroidx/media3/exoplayer/drm/DefaultDrmSession$d;->e:I

    invoke-direct {v8, v4, v6, v2, v3}, Landroidx/media3/exoplayer/upstream/i$a;-><init>(Landroidx/media3/exoplayer/source/w;Landroidx/media3/exoplayer/source/z;Ljava/io/IOException;I)V

    invoke-interface {v7, v8}, Landroidx/media3/exoplayer/upstream/i;->a(Landroidx/media3/exoplayer/upstream/i$a;)J
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v1}, Landroidx/media3/exoplayer/drm/DefaultDrmSession;->o(Landroidx/media3/exoplayer/drm/DefaultDrmSession;)Landroidx/media3/exoplayer/drm/d0;
    ...
    check-cast v3, Landroidx/media3/exoplayer/drm/x$a;

    invoke-interface {v1, v2, v3}, Landroidx/media3/exoplayer/drm/d0;->a(Ljava/util/UUID;Landroidx/media3/exoplayer/drm/x$a;)[B
    ...
    check-cast v3, Landroidx/media3/exoplayer/drm/x$d;

    invoke-interface {v1, v2, v3}, Landroidx/media3/exoplayer/drm/d0;->b(Ljava/util/UUID;Landroidx/media3/exoplayer/drm/x$d;)[B
    ...
    invoke-static {v2, v3, v1}, Landroidx/media3/common/util/t;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v2}, Landroidx/media3/exoplayer/drm/DefaultDrmSession;->p(Landroidx/media3/exoplayer/drm/DefaultDrmSession;)Landroidx/media3/exoplayer/upstream/i;
    ...
    invoke-static {v2}, Landroidx/media3/exoplayer/drm/DefaultDrmSession;->q(Landroidx/media3/exoplayer/drm/DefaultDrmSession;)Landroidx/media3/exoplayer/drm/DefaultDrmSession$e;
