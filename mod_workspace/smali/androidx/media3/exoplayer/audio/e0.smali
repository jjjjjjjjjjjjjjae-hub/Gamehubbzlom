...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/media3/exoplayer/audio/e0;->d:[B
    ...
    sput-object v0, Landroidx/media3/exoplayer/audio/e0;->e:[B
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/media3/exoplayer/audio/e0;->a:Ljava/nio/ByteBuffer;

    const/4 v0, 0x0

    iput v0, p0, Landroidx/media3/exoplayer/audio/e0;->c:I

    const/4 v0, 0x2

    iput v0, p0, Landroidx/media3/exoplayer/audio/e0;->b:I
...
.method public a(Landroidx/media3/decoder/DecoderInputBuffer;Ljava/util/List;)V
    ...
    invoke-virtual {p0, v0, p2}, Landroidx/media3/exoplayer/audio/e0;->b(Ljava/nio/ByteBuffer;[B)Ljava/nio/ByteBuffer;

    move-result-object p2

    iput-object p2, p0, Landroidx/media3/exoplayer/audio/e0;->a:Ljava/nio/ByteBuffer;

    invoke-virtual {p1}, Landroidx/media3/decoder/DecoderInputBuffer;->n()V

    iget-object p2, p0, Landroidx/media3/exoplayer/audio/e0;->a:Ljava/nio/ByteBuffer;
    ...
    iget-object p0, p0, Landroidx/media3/exoplayer/audio/e0;->a:Ljava/nio/ByteBuffer;
...
.method public final b(Ljava/nio/ByteBuffer;[B)Ljava/nio/ByteBuffer;
    ...
    iget v2, v7, Landroidx/media3/exoplayer/audio/e0;->b:I
    ...
    :cond_0
    sget-object v2, Landroidx/media3/exoplayer/audio/e0;->d:[B

    array-length v2, v2

    :goto_0
    sget-object v3, Landroidx/media3/exoplayer/audio/e0;->e:[B
    ...
    :goto_1
    invoke-virtual {v7, v1}, Landroidx/media3/exoplayer/audio/e0;->c(I)Ljava/nio/ByteBuffer;

    move-result-object v6

    iget v1, v7, Landroidx/media3/exoplayer/audio/e0;->b:I

    if-ne v1, v15, :cond_3

    if-eqz v0, :cond_2

    invoke-virtual {v7, v6, v0}, Landroidx/media3/exoplayer/audio/e0;->e(Ljava/nio/ByteBuffer;[B)V

    goto :goto_2

    :cond_2
    sget-object v0, Landroidx/media3/exoplayer/audio/e0;->d:[B

    invoke-virtual {v6, v0}, Ljava/nio/ByteBuffer;->put([B)Ljava/nio/ByteBuffer;

    :goto_2
    sget-object v0, Landroidx/media3/exoplayer/audio/e0;->e:[B

    invoke-virtual {v6, v0}, Ljava/nio/ByteBuffer;->put([B)Ljava/nio/ByteBuffer;

    :cond_3
    invoke-static/range {p1 .. p1}, Landroidx/media3/extractor/h0;->j(Ljava/nio/ByteBuffer;)I

    move-result v0

    iget v1, v7, Landroidx/media3/exoplayer/audio/e0;->c:I

    add-int/2addr v1, v0

    iput v1, v7, Landroidx/media3/exoplayer/audio/e0;->c:I

    int-to-long v2, v1

    iget v4, v7, Landroidx/media3/exoplayer/audio/e0;->b:I
    ...
    invoke-virtual/range {v0 .. v6}, Landroidx/media3/exoplayer/audio/e0;->f(Ljava/nio/ByteBuffer;JIIZ)V
    ...
    iget v0, v7, Landroidx/media3/exoplayer/audio/e0;->b:I
    ...
    invoke-static {v0, v2, v4, v5}, Landroidx/media3/common/util/m0;->w([BIII)I
    ...
    invoke-static {v0, v2, v3, v5}, Landroidx/media3/common/util/m0;->w([BIII)I
    ...
    iput v0, v7, Landroidx/media3/exoplayer/audio/e0;->b:I
...
.method public final c(I)Ljava/nio/ByteBuffer;
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/audio/e0;->a:Ljava/nio/ByteBuffer;
    ...
    iput-object p1, p0, Landroidx/media3/exoplayer/audio/e0;->a:Ljava/nio/ByteBuffer;

    goto :goto_0

    :cond_0
    iget-object p1, p0, Landroidx/media3/exoplayer/audio/e0;->a:Ljava/nio/ByteBuffer;
...
.method public final e(Ljava/nio/ByteBuffer;[B)V
    ...
    invoke-static {p0, v0, v1, v2}, Landroidx/media3/common/util/m0;->w([BIII)I
