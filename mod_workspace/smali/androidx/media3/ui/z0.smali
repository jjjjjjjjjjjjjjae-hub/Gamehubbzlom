.class public abstract Landroidx/media3/ui/z0;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroidx/media3/ui/z0$b;,
        Landroidx/media3/ui/z0$d;,
        Landroidx/media3/ui/z0$c;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/media3/ui/z0;->a:Ljava/util/regex/Pattern;

    return-void
.end method

.method public static a(Ljava/lang/CharSequence;F)Landroidx/media3/ui/z0$b;
    .locals 8
    ...
    new-instance p0, Landroidx/media3/ui/z0$b;
    ...
    invoke-direct {p0, p1, v1, v0}, Landroidx/media3/ui/z0$b;-><init>(Ljava/lang/String;Ljava/util/Map;Landroidx/media3/ui/z0$a;)V
    ...
    new-instance p1, Landroidx/media3/ui/z0$b;

    invoke-static {p0}, Landroidx/media3/ui/z0;->b(Ljava/lang/CharSequence;)Ljava/lang/String;
    ...
    invoke-direct {p1, p0, v1, v0}, Landroidx/media3/ui/z0$b;-><init>(Ljava/lang/String;Ljava/util/Map;Landroidx/media3/ui/z0$a;)V
    ...
    invoke-static {v6, v3}, Landroidx/media3/common/util/m0;->F(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p0, p1}, Landroidx/media3/ui/z0;->c(Landroid/text/Spanned;F)Landroid/util/SparseArray;
    ...
    invoke-static {v3}, Landroidx/media3/ui/z0;->b(Ljava/lang/CharSequence;)Ljava/lang/String;
    ...
    check-cast v3, Landroidx/media3/ui/z0$d;

    invoke-static {v3}, Landroidx/media3/ui/z0$d;->a(Landroidx/media3/ui/z0$d;)Ljava/util/List;

    move-result-object v6

    invoke-static {}, Landroidx/media3/ui/z0$c;->c()Ljava/util/Comparator;
    ...
    check-cast v7, Landroidx/media3/ui/z0$c;

    iget-object v7, v7, Landroidx/media3/ui/z0$c;->d:Ljava/lang/String;
    ...
    :cond_4
    invoke-static {v3}, Landroidx/media3/ui/z0$d;->b(Landroidx/media3/ui/z0$d;)Ljava/util/List;

    move-result-object v6

    invoke-static {}, Landroidx/media3/ui/z0$c;->d()Ljava/util/Comparator;
    ...
    check-cast v6, Landroidx/media3/ui/z0$c;

    iget-object v6, v6, Landroidx/media3/ui/z0$c;->c:Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v2, v0}, Landroidx/media3/ui/z0$b;-><init>(Ljava/lang/String;Ljava/util/Map;Landroidx/media3/ui/z0$a;)V
...
.method public static b(Ljava/lang/CharSequence;)Ljava/lang/String;
    ...
    sget-object v0, Landroidx/media3/ui/z0;->a:Ljava/util/regex/Pattern;
...
.method public static c(Landroid/text/Spanned;F)Landroid/util/SparseArray;
    ...
    invoke-static {v4, p1}, Landroidx/media3/ui/z0;->e(Ljava/lang/Object;F)Ljava/lang/String;

    move-result-object v8

    invoke-static {v4}, Landroidx/media3/ui/z0;->d(Ljava/lang/Object;)Ljava/lang/String;
    ...
    new-instance v12, Landroidx/media3/ui/z0$c;
    ...
    invoke-direct/range {v5 .. v10}, Landroidx/media3/ui/z0$c;-><init>(IILjava/lang/String;Ljava/lang/String;Landroidx/media3/ui/z0$a;)V

    invoke-static {v0, v11}, Landroidx/media3/ui/z0;->f(Landroid/util/SparseArray;I)Landroidx/media3/ui/z0$d;

    move-result-object v5

    invoke-static {v5}, Landroidx/media3/ui/z0$d;->b(Landroidx/media3/ui/z0$d;)Ljava/util/List;

    move-result-object v5

    invoke-interface {v5, v12}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-static {v0, v4}, Landroidx/media3/ui/z0;->f(Landroid/util/SparseArray;I)Landroidx/media3/ui/z0$d;

    move-result-object v4

    invoke-static {v4}, Landroidx/media3/ui/z0$d;->a(Landroidx/media3/ui/z0$d;)Ljava/util/List;
...
.method public static e(Ljava/lang/Object;F)Ljava/lang/String;
    ...
    iget v0, p0, Landroidx/media3/common/text/h;->b:I

    invoke-static {p1, v0}, Landroidx/media3/ui/z0;->h(II)Ljava/lang/String;

    move-result-object p1

    iget p0, p0, Landroidx/media3/common/text/h;->c:I

    invoke-static {p0}, Landroidx/media3/ui/z0;->g(I)Ljava/lang/String;
...
.method public static f(Landroid/util/SparseArray;I)Landroidx/media3/ui/z0$d;
    .locals 1
    ...
    check-cast v0, Landroidx/media3/ui/z0$d;

    if-nez v0, :cond_0

    new-instance v0, Landroidx/media3/ui/z0$d;

    invoke-direct {v0}, Landroidx/media3/ui/z0$d;-><init>()V
