.class public abstract Landroidx/media3/extractor/text/ttml/f;
...
.method public static a(Landroid/text/Spannable;IILandroidx/media3/extractor/text/ttml/g;Landroidx/media3/extractor/text/ttml/c;Ljava/util/Map;I)V
    ...
    invoke-virtual {p3}, Landroidx/media3/extractor/text/ttml/g;->n()I
    ...
    :cond_1
    invoke-virtual {p3}, Landroidx/media3/extractor/text/ttml/g;->v()Z
    ...
    :cond_2
    invoke-virtual {p3}, Landroidx/media3/extractor/text/ttml/g;->s()Z
    ...
    invoke-virtual {p3}, Landroidx/media3/extractor/text/ttml/g;->d()I

    move-result v3

    invoke-direct {v0, v3}, Landroid/text/style/ForegroundColorSpan;-><init>(I)V

    invoke-static {p0, v0, p1, p2, v1}, Landroidx/media3/common/text/g;->b(Landroid/text/Spannable;Ljava/lang/Object;III)V

    :cond_3
    invoke-virtual {p3}, Landroidx/media3/extractor/text/ttml/g;->r()Z
    ...
    :cond_4
    invoke-virtual {p3}, Landroidx/media3/extractor/text/ttml/g;->e()Ljava/lang/String;
    ...
    :cond_5
    invoke-virtual {p3}, Landroidx/media3/extractor/text/ttml/g;->q()Landroidx/media3/extractor/text/ttml/b;
    ...
    :cond_9
    new-instance v7, Landroidx/media3/common/text/h;

    invoke-direct {v7, v6, p6, v0}, Landroidx/media3/common/text/h;-><init>(III)V

    invoke-static {p0, v7, p1, p2, v1}, Landroidx/media3/common/text/g;->b(Landroid/text/Spannable;Ljava/lang/Object;III)V
    ...
    invoke-virtual {p6}, Landroidx/media3/extractor/text/ttml/g;->k()I
    ...
    invoke-virtual {p4}, Landroidx/media3/extractor/text/ttml/g;->k()I
    ...
    invoke-direct {p4, v0, p6}, Landroidx/media3/common/text/f;-><init>(Ljava/lang/String;I)V
    ...
    invoke-static {p4, p5}, Landroidx/media3/common/util/t;->f(Ljava/lang/String;Ljava/lang/String;)V
    ...
    new-instance p4, Landroidx/media3/common/text/d;

    invoke-direct {p4}, Landroidx/media3/common/text/d;-><init>()V

    invoke-static {p0, p4, p1, p2, v1}, Landroidx/media3/common/text/g;->b(Landroid/text/Spannable;Ljava/lang/Object;III)V

    :cond_12
    invoke-virtual {p3}, Landroidx/media3/extractor/text/ttml/g;->g()I
    ...
    :cond_13
    invoke-virtual {p3}, Landroidx/media3/extractor/text/ttml/g;->f()F
    ...
    invoke-static {p0, p3, p1, p2, v1}, Landroidx/media3/common/text/g;->a(Landroid/text/Spannable;FIII)V
...
.method public static d(Landroidx/media3/extractor/text/ttml/c;Ljava/util/Map;)Landroidx/media3/extractor/text/ttml/c;
    .locals 2
    ...
    invoke-virtual {v0}, Landroidx/media3/extractor/text/ttml/g;->l()I
...
.method public static e(Landroidx/media3/extractor/text/ttml/c;Ljava/util/Map;)Landroidx/media3/extractor/text/ttml/c;
    .locals 3
    ...
    invoke-virtual {v1}, Landroidx/media3/extractor/text/ttml/g;->l()I
