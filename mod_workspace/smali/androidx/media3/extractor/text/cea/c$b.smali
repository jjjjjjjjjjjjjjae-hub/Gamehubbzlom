.class public final Landroidx/media3/extractor/text/cea/c$b;
...
.method static constructor <clinit>()V
    ...
    sput v0, Landroidx/media3/extractor/text/cea/c$b;->v:I

    invoke-static {v1, v1, v1, v1}, Landroidx/media3/extractor/text/cea/c$b;->h(IIII)I

    move-result v0

    sput v0, Landroidx/media3/extractor/text/cea/c$b;->w:I
    ...
    sput v1, Landroidx/media3/extractor/text/cea/c$b;->x:I
    ...
    sput-object v2, Landroidx/media3/extractor/text/cea/c$b;->A:[I

    new-array v2, v9, [Z

    fill-array-data v2, :array_3

    sput-object v2, Landroidx/media3/extractor/text/cea/c$b;->B:[Z
    ...
    sput-object v2, Landroidx/media3/extractor/text/cea/c$b;->C:[I

    new-array v2, v9, [I

    fill-array-data v2, :array_4

    sput-object v2, Landroidx/media3/extractor/text/cea/c$b;->D:[I

    new-array v2, v9, [I

    fill-array-data v2, :array_5

    sput-object v2, Landroidx/media3/extractor/text/cea/c$b;->E:[I
    ...
    sput-object v0, Landroidx/media3/extractor/text/cea/c$b;->F:[I
...
.method public a(C)V
    ...
    :cond_6
    iget-object p0, p0, Landroidx/media3/extractor/text/cea/c$b;->b:Landroid/text/SpannableStringBuilder;
...
.method public c()Landroidx/media3/extractor/text/cea/c$a;
    ...
    iget p0, p0, Landroidx/media3/extractor/text/cea/c$b;->k:I
    ...
    :goto_2
    iget-boolean v6, p0, Landroidx/media3/extractor/text/cea/c$b;->f:Z

    if-eqz v6, :cond_6

    iget v6, p0, Landroidx/media3/extractor/text/cea/c$b;->h:I
    ...
    iget v8, p0, Landroidx/media3/extractor/text/cea/c$b;->i:I
    ...
    :goto_5
    iget v3, p0, Landroidx/media3/extractor/text/cea/c$b;->n:I

    sget v4, Landroidx/media3/extractor/text/cea/c$b;->w:I
    ...
    :goto_6
    new-instance v12, Landroidx/media3/extractor/text/cea/c$a;

    iget v11, p0, Landroidx/media3/extractor/text/cea/c$b;->n:I

    iget p0, p0, Landroidx/media3/extractor/text/cea/c$b;->e:I
    ...
    invoke-direct/range {v0 .. v11}, Landroidx/media3/extractor/text/cea/c$a;-><init>(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;FIIFIFZII)V
...
.method public d()Landroid/text/SpannableString;
    ...
    iget p0, p0, Landroidx/media3/extractor/text/cea/c$b;->s:I
...
.method public f(ZIZIIIIII)V
    ...
    sget-object v4, Landroidx/media3/extractor/text/cea/c$b;->C:[I

    aget v4, v4, v1

    sget v5, Landroidx/media3/extractor/text/cea/c$b;->x:I

    sget-object v6, Landroidx/media3/extractor/text/cea/c$b;->B:[Z

    aget-boolean v6, v6, v1

    sget-object v7, Landroidx/media3/extractor/text/cea/c$b;->z:[I

    aget v7, v7, v1

    sget-object v8, Landroidx/media3/extractor/text/cea/c$b;->A:[I

    aget v8, v8, v1

    sget-object v9, Landroidx/media3/extractor/text/cea/c$b;->y:[I
    ...
    invoke-virtual/range {p1 .. p8}, Landroidx/media3/extractor/text/cea/c$b;->q(IIZIIII)V
    ...
    sget-object v2, Landroidx/media3/extractor/text/cea/c$b;->E:[I

    aget v2, v2, v1

    sget-object v3, Landroidx/media3/extractor/text/cea/c$b;->D:[I
    ...
    sget v2, Landroidx/media3/extractor/text/cea/c$b;->v:I

    sget-object v3, Landroidx/media3/extractor/text/cea/c$b;->F:[I

    aget v1, v3, v1

    sget v3, Landroidx/media3/extractor/text/cea/c$b;->w:I
...
.method public i()Z
    ...
    iget-boolean p0, p0, Landroidx/media3/extractor/text/cea/c$b;->c:Z
...
.method public j()Z
    ...
    invoke-virtual {p0}, Landroidx/media3/extractor/text/cea/c$b;->i()Z
...
.method public k()Z
    ...
    iget-boolean p0, p0, Landroidx/media3/extractor/text/cea/c$b;->d:Z
...
.method public l()V
    ...
    sget v0, Landroidx/media3/extractor/text/cea/c$b;->w:I

    iput v0, p0, Landroidx/media3/extractor/text/cea/c$b;->n:I

    sget v1, Landroidx/media3/extractor/text/cea/c$b;->v:I
...
.method public n(III)V
    ...
    :cond_0
    sget p3, Landroidx/media3/extractor/text/cea/c$b;->v:I
    ...
    :cond_2
    sget p1, Landroidx/media3/extractor/text/cea/c$b;->w:I
