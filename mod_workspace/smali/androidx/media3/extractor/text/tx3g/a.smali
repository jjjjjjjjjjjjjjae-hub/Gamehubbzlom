...
.method public constructor <init>(Ljava/util/List;)V
    ...
    iput-object v0, p0, Landroidx/media3/extractor/text/tx3g/a;->a:Landroidx/media3/common/util/c0;
    ...
    invoke-static {p1, v5, v0}, Landroidx/media3/common/util/m0;->H([BII)Ljava/lang/String;
...
.method public static i(Landroidx/media3/common/util/c0;)Ljava/lang/String;
    .locals 4
    ...
    :goto_1
    invoke-virtual {p0, v0, v2}, Landroidx/media3/common/util/c0;->F(ILjava/nio/charset/Charset;)Ljava/lang/String;
...
.method public a([BIILandroidx/media3/extractor/text/r$b;Landroidx/media3/common/util/l;)V
    ...
    iget-object v3, v0, Landroidx/media3/extractor/text/tx3g/a;->a:Landroidx/media3/common/util/c0;

    add-int v4, v1, p3

    move-object/from16 v5, p1

    invoke-virtual {v3, v5, v4}, Landroidx/media3/common/util/c0;->U([BI)V

    iget-object v3, v0, Landroidx/media3/extractor/text/tx3g/a;->a:Landroidx/media3/common/util/c0;

    invoke-virtual {v3, v1}, Landroidx/media3/common/util/c0;->W(I)V

    iget-object v1, v0, Landroidx/media3/extractor/text/tx3g/a;->a:Landroidx/media3/common/util/c0;

    invoke-static {v1}, Landroidx/media3/extractor/text/tx3g/a;->i(Landroidx/media3/common/util/c0;)Ljava/lang/String;
    ...
    invoke-direct/range {v4 .. v9}, Landroidx/media3/extractor/text/e;-><init>(Ljava/util/List;JJ)V

    invoke-interface {v2, v0}, Landroidx/media3/common/util/l;->accept(Ljava/lang/Object;)V
    ...
    :goto_0
    iget-object v4, v0, Landroidx/media3/extractor/text/tx3g/a;->a:Landroidx/media3/common/util/c0;

    invoke-virtual {v4}, Landroidx/media3/common/util/c0;->a()I
    ...
    iget-object v6, v0, Landroidx/media3/extractor/text/tx3g/a;->a:Landroidx/media3/common/util/c0;

    invoke-virtual {v6}, Landroidx/media3/common/util/c0;->q()I

    move-result v6

    iget-object v7, v0, Landroidx/media3/extractor/text/tx3g/a;->a:Landroidx/media3/common/util/c0;

    invoke-virtual {v7}, Landroidx/media3/common/util/c0;->q()I
    ...
    invoke-virtual {v7}, Landroidx/media3/common/util/c0;->a()I
    ...
    invoke-virtual {v7}, Landroidx/media3/common/util/c0;->P()I
    ...
    iget-object v9, v0, Landroidx/media3/extractor/text/tx3g/a;->a:Landroidx/media3/common/util/c0;

    invoke-virtual {v0, v9, v3}, Landroidx/media3/extractor/text/tx3g/a;->e(Landroidx/media3/common/util/c0;Landroid/text/SpannableStringBuilder;)V
    ...
    invoke-static {v1, v7, v8}, Landroidx/media3/common/util/m0;->n(FFF)F
    ...
    invoke-virtual {v7, v4}, Landroidx/media3/common/util/c0;->W(I)V
    ...
    invoke-virtual {v0, v3}, Landroidx/media3/common/text/a$b;->o(Ljava/lang/CharSequence;)Landroidx/media3/common/text/a$b;

    move-result-object v0

    invoke-virtual {v0, v1, v5}, Landroidx/media3/common/text/a$b;->h(FI)Landroidx/media3/common/text/a$b;

    move-result-object v0

    invoke-virtual {v0, v5}, Landroidx/media3/common/text/a$b;->i(I)Landroidx/media3/common/text/a$b;
    ...
    invoke-interface {v2, v1}, Landroidx/media3/common/util/l;->accept(Ljava/lang/Object;)V
...
.method public final e(Landroidx/media3/common/util/c0;Landroid/text/SpannableStringBuilder;)V
    .locals 9
    ...
    invoke-virtual {p1, v2}, Landroidx/media3/common/util/c0;->X(I)V
    ...
    invoke-static {v5, v1}, Landroidx/media3/common/util/t;->h(Ljava/lang/String;Ljava/lang/String;)V
