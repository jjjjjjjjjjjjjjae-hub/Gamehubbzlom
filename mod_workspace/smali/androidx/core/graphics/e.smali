...
.method public static f(Landroid/os/CancellationSignal;[Landroidx/core/provider/g$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    .locals 8
...
.method public a(Landroid/content/Context;Landroidx/core/content/res/e$c;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {p0, p2, p4}, Landroidx/core/graphics/e;->e(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public b(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroidx/core/provider/g$b;I)Landroid/graphics/Typeface;
    ...
    :try_start_0
    invoke-static {p2, p3, p1}, Landroidx/core/graphics/e;->f(Landroid/os/CancellationSignal;[Landroidx/core/provider/g$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    invoke-virtual {p0, p1, p4}, Landroidx/core/graphics/e;->e(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public c(Landroid/content/Context;Landroid/os/CancellationSignal;Ljava/util/List;I)Landroid/graphics/Typeface;
    ...
    invoke-static {p2, v0, p1}, Landroidx/core/graphics/e;->f(Landroid/os/CancellationSignal;[Landroidx/core/provider/g$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    check-cast v4, [Landroidx/core/provider/g$b;

    invoke-static {p2, v4, p1}, Landroidx/core/graphics/e;->f(Landroid/os/CancellationSignal;[Landroidx/core/provider/g$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    :cond_2
    invoke-virtual {p0, v0, p4}, Landroidx/core/graphics/e;->e(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final e(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
    .locals 4
    ...
    invoke-static {p0, v0}, Landroidx/core/graphics/e;->g(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    ...
    invoke-static {p0, v3}, Landroidx/core/graphics/e;->g(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
