...
.method public static a(Landroid/content/res/Resources;ILandroidx/core/util/j;I)I
    .locals 1
    ...
    :cond_2
    invoke-interface {p2}, Landroidx/core/util/j;->get()Ljava/lang/Object;
...
.method public static c(Landroid/content/res/Resources;II)I
    ...
    invoke-static {p0, p1, p2}, Landroidx/core/view/w0;->b(Landroid/content/res/Resources;Ljava/lang/String;Ljava/lang/String;)I
...
.method public static f(Landroid/view/ViewConfiguration;)I
    .locals 0
...
.method public static g(Landroid/content/Context;Landroid/view/ViewConfiguration;III)I
    ...
    invoke-static {p1, p2, p3, p4}, Landroidx/core/view/w0$c;->a(Landroid/view/ViewConfiguration;III)I
    ...
    :cond_0
    invoke-static {p2, p3, p4}, Landroidx/core/view/w0;->j(III)Z
    ...
    invoke-static {p0, p4, p3}, Landroidx/core/view/w0;->c(Landroid/content/res/Resources;II)I
    ...
    invoke-direct {p3, p1}, Landroidx/core/view/u0;-><init>(Landroid/view/ViewConfiguration;)V

    invoke-static {p0, p2, p3, v0}, Landroidx/core/view/w0;->a(Landroid/content/res/Resources;ILandroidx/core/util/j;I)I
...
.method public static h(Landroid/content/Context;Landroid/view/ViewConfiguration;III)I
    ...
    invoke-static {p1, p2, p3, p4}, Landroidx/core/view/w0$c;->b(Landroid/view/ViewConfiguration;III)I
    ...
    invoke-static {p0, p4, p3}, Landroidx/core/view/w0;->d(Landroid/content/res/Resources;II)I

    move-result p2

    invoke-static {p1}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    new-instance p3, Landroidx/core/view/v0;

    invoke-direct {p3, p1}, Landroidx/core/view/v0;-><init>(Landroid/view/ViewConfiguration;)V
