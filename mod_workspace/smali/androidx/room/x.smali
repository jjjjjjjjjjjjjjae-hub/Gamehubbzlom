...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/io/File;Ljava/util/concurrent/Callable;ILandroidx/sqlite/db/h;)V
    ...
    iput-object p3, p0, Landroidx/room/x;->c:Ljava/io/File;

    iput-object p4, p0, Landroidx/room/x;->d:Ljava/util/concurrent/Callable;

    iput p5, p0, Landroidx/room/x;->e:I

    iput-object p6, p0, Landroidx/room/x;->f:Landroidx/sqlite/db/h;
...
.method public a()Landroidx/sqlite/db/h;
    ...
    iget-object p0, p0, Landroidx/room/x;->f:Landroidx/sqlite/db/h;
...
.method public final b(Ljava/io/File;Z)V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/room/x;->c:Ljava/io/File;

    if-eqz v0, :cond_1

    new-instance v0, Ljava/io/FileInputStream;

    iget-object v1, p0, Landroidx/room/x;->c:Ljava/io/File;
    ...
    :cond_1
    iget-object v0, p0, Landroidx/room/x;->d:Ljava/util/concurrent/Callable;
    ...
    :goto_0
    iget-object v1, p0, Landroidx/room/x;->a:Landroid/content/Context;
    ...
    invoke-virtual {p0, v1, p2}, Landroidx/room/x;->c(Ljava/io/File;Z)V
...
.method public final c(Ljava/io/File;Z)V
    ...
    iget-object p0, p0, Landroidx/room/x;->g:Landroidx/room/f;
...
.method public declared-synchronized close()V
    ...
    :try_start_0
    invoke-virtual {p0}, Landroidx/room/x;->a()Landroidx/sqlite/db/h;
    ...
    iput-boolean v0, p0, Landroidx/room/x;->h:Z
    :try_end_0
...
.method public final d(Landroidx/room/f;)V
    .locals 1
    ...
    iput-object p1, p0, Landroidx/room/x;->g:Landroidx/room/f;
...
.method public final e(Z)V
    ...
    invoke-virtual {p0}, Landroidx/room/x;->getDatabaseName()Ljava/lang/String;

    move-result-object v1

    if-eqz v1, :cond_6

    iget-object v2, p0, Landroidx/room/x;->a:Landroid/content/Context;

    invoke-virtual {v2, v1}, Landroid/content/Context;->getDatabasePath(Ljava/lang/String;)Ljava/io/File;

    move-result-object v2

    iget-object v3, p0, Landroidx/room/x;->g:Landroidx/room/f;
    ...
    iget-object v7, p0, Landroidx/room/x;->a:Landroid/content/Context;
    ...
    invoke-virtual {p0, v2, p1}, Landroidx/room/x;->b(Ljava/io/File;Z)V
    :try_end_1
    ...
    invoke-static {v2}, Landroidx/room/util/b;->d(Ljava/io/File;)I
    ...
    :try_start_4
    iget v8, p0, Landroidx/room/x;->e:I
    :try_end_4
    ...
    :cond_2
    :try_start_5
    iget-object v8, p0, Landroidx/room/x;->g:Landroidx/room/f;
    ...
    :goto_0
    iget v4, p0, Landroidx/room/x;->e:I
    ...
    :cond_4
    :try_start_6
    iget-object v3, p0, Landroidx/room/x;->a:Landroid/content/Context;
...
.method public getWritableDatabase()Landroidx/sqlite/db/g;
    ...
    iget-boolean v0, p0, Landroidx/room/x;->h:Z

    if-nez v0, :cond_0

    const/4 v0, 0x1

    invoke-virtual {p0, v0}, Landroidx/room/x;->e(Z)V
