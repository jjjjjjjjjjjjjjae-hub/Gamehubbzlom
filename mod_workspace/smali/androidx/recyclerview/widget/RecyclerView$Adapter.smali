...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/RecyclerView$Adapter;->mObservable:Landroidx/recyclerview/widget/RecyclerView$s;
...
# virtual methods
.method public final bindViewHolder(Landroidx/recyclerview/widget/RecyclerView$u0;I)V
    .locals 4
    ...
    iget-object v0, p1, Landroidx/recyclerview/widget/RecyclerView$u0;->mBindingAdapter:Landroidx/recyclerview/widget/RecyclerView$Adapter;
    ...
    iput p2, p1, Landroidx/recyclerview/widget/RecyclerView$u0;->mPosition:I
    ...
    iput-wide v2, p1, Landroidx/recyclerview/widget/RecyclerView$u0;->mItemId:J

    :cond_1
    const/16 v2, 0x207

    invoke-virtual {p1, v1, v2}, Landroidx/recyclerview/widget/RecyclerView$u0;->setFlags(II)V
    ...
    invoke-static {v2}, Landroidx/core/view/t0;->L(Landroid/view/View;)Z
    ...
    :cond_6
    :goto_2
    invoke-virtual {p1}, Landroidx/recyclerview/widget/RecyclerView$u0;->getUnmodifiedPayloads()Ljava/util/List;

    move-result-object v2

    invoke-virtual {p0, p1, p2, v2}, Landroidx/recyclerview/widget/RecyclerView$Adapter;->onBindViewHolder(Landroidx/recyclerview/widget/RecyclerView$u0;ILjava/util/List;)V

    if-eqz v0, :cond_8

    invoke-virtual {p1}, Landroidx/recyclerview/widget/RecyclerView$u0;->clearPayload()V
    ...
    instance-of p1, p0, Landroidx/recyclerview/widget/RecyclerView$c0;

    if-eqz p1, :cond_7

    check-cast p0, Landroidx/recyclerview/widget/RecyclerView$c0;

    iput-boolean v1, p0, Landroidx/recyclerview/widget/RecyclerView$c0;->c:Z
...
.method public final createViewHolder(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$u0;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput p2, p0, Landroidx/recyclerview/widget/RecyclerView$u0;->mItemViewType:I
    :try_end_0
...
.method public findRelativeAdapterPositionIn(Landroidx/recyclerview/widget/RecyclerView$Adapter;Landroidx/recyclerview/widget/RecyclerView$u0;I)I
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final hasObservers()Z
    ...
    iget-object p0, p0, Landroidx/recyclerview/widget/RecyclerView$Adapter;->mObservable:Landroidx/recyclerview/widget/RecyclerView$s;

    invoke-virtual {p0}, Landroidx/recyclerview/widget/RecyclerView$s;->a()Z
...
.method public final notifyItemChanged(I)V
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/recyclerview/widget/RecyclerView$s;->d(II)V
...
.method public final notifyItemChanged(ILjava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, v0, p2}, Landroidx/recyclerview/widget/RecyclerView$s;->e(IILjava/lang/Object;)V
...
.method public final notifyItemInserted(I)V
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/recyclerview/widget/RecyclerView$s;->f(II)V
...
.method public final notifyItemMoved(II)V
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/recyclerview/widget/RecyclerView$s;->c(II)V
...
.method public final notifyItemRangeChanged(II)V
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/recyclerview/widget/RecyclerView$s;->d(II)V
...
.method public final notifyItemRangeChanged(IILjava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Landroidx/recyclerview/widget/RecyclerView$s;->e(IILjava/lang/Object;)V
...
.method public final notifyItemRangeInserted(II)V
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/recyclerview/widget/RecyclerView$s;->f(II)V
...
.method public final notifyItemRangeRemoved(II)V
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/recyclerview/widget/RecyclerView$s;->g(II)V
...
.method public final notifyItemRemoved(I)V
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/recyclerview/widget/RecyclerView$s;->g(II)V
...
.method public abstract onBindViewHolder(Landroidx/recyclerview/widget/RecyclerView$u0;I)V
.end method

.method public onBindViewHolder(Landroidx/recyclerview/widget/RecyclerView$u0;ILjava/util/List;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Landroidx/recyclerview/widget/RecyclerView$Adapter;->onBindViewHolder(Landroidx/recyclerview/widget/RecyclerView$u0;I)V

    return-void
.end method

.method public abstract onCreateViewHolder(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$u0;
.end method
...
.method public onFailedToRecycleView(Landroidx/recyclerview/widget/RecyclerView$u0;)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public onViewAttachedToWindow(Landroidx/recyclerview/widget/RecyclerView$u0;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public onViewDetachedFromWindow(Landroidx/recyclerview/widget/RecyclerView$u0;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public onViewRecycled(Landroidx/recyclerview/widget/RecyclerView$u0;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
