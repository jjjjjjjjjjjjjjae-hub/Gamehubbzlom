...
.method public static e(Landroidx/recyclerview/widget/RecyclerView;I)Z
    ...
    invoke-static {v3}, Landroidx/recyclerview/widget/RecyclerView;->P1(Landroid/view/View;)Landroidx/recyclerview/widget/RecyclerView$u0;

    move-result-object v3

    iget v4, v3, Landroidx/recyclerview/widget/RecyclerView$u0;->mPosition:I
...
.method public a(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    :cond_1
    :goto_0
    iget-object p0, p0, Landroidx/recyclerview/widget/l;->a:Ljava/util/ArrayList;
...
.method public final b()V
    ...
    iget-object v5, v4, Landroidx/recyclerview/widget/RecyclerView;->A0:Landroidx/recyclerview/widget/l$b;
    ...
    :cond_6
    iget-object p0, p0, Landroidx/recyclerview/widget/l;->d:Ljava/util/ArrayList;

    sget-object v0, Landroidx/recyclerview/widget/l;->f:Ljava/util/Comparator;
...
.method public final c(Landroidx/recyclerview/widget/l$c;J)V
    ...
    invoke-virtual {p0, v2, p1, v0, v1}, Landroidx/recyclerview/widget/l;->i(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$u0;

    move-result-object p1

    if-eqz p1, :cond_1

    iget-object v0, p1, Landroidx/recyclerview/widget/RecyclerView$u0;->mNestedRecyclerView:Ljava/lang/ref/WeakReference;

    if-eqz v0, :cond_1

    invoke-virtual {p1}, Landroidx/recyclerview/widget/RecyclerView$u0;->isBound()Z
    ...
    iget-object p1, p1, Landroidx/recyclerview/widget/RecyclerView$u0;->mNestedRecyclerView:Ljava/lang/ref/WeakReference;
...
.method public f(Landroidx/recyclerview/widget/RecyclerView;II)V
    ...
    :cond_2
    iget-object p0, p1, Landroidx/recyclerview/widget/RecyclerView;->A0:Landroidx/recyclerview/widget/l$b;

    invoke-virtual {p0, p2, p3}, Landroidx/recyclerview/widget/l$b;->e(II)V
...
.method public final h(Landroidx/recyclerview/widget/RecyclerView;J)V
    ...
    :cond_0
    iget-boolean v0, p1, Landroidx/recyclerview/widget/RecyclerView;->a0:Z
    ...
    invoke-virtual {p1}, Landroidx/recyclerview/widget/RecyclerView;->X2()V

    :cond_1
    iget-object v0, p1, Landroidx/recyclerview/widget/RecyclerView;->A0:Landroidx/recyclerview/widget/l$b;
    ...
    iget-object v1, p1, Landroidx/recyclerview/widget/RecyclerView;->B0:Landroidx/recyclerview/widget/RecyclerView$q0;

    iget-object v2, p1, Landroidx/recyclerview/widget/RecyclerView;->m:Landroidx/recyclerview/widget/RecyclerView$Adapter;

    invoke-virtual {v1, v2}, Landroidx/recyclerview/widget/RecyclerView$q0;->f(Landroidx/recyclerview/widget/RecyclerView$Adapter;)V
    ...
    invoke-virtual {p0, p1, v2, p2, p3}, Landroidx/recyclerview/widget/l;->i(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$u0;
    :try_end_0
...
.method public final i(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$u0;
    .locals 1
    ...
    :try_start_0
    invoke-virtual {p1}, Landroidx/recyclerview/widget/RecyclerView;->E2()V

    invoke-virtual {p0, p2, v0, p3, p4}, Landroidx/recyclerview/widget/RecyclerView$i0;->N(IZJ)Landroidx/recyclerview/widget/RecyclerView$u0;

    move-result-object p2

    if-eqz p2, :cond_2

    invoke-virtual {p2}, Landroidx/recyclerview/widget/RecyclerView$u0;->isBound()Z

    move-result p3

    if-eqz p3, :cond_1

    invoke-virtual {p2}, Landroidx/recyclerview/widget/RecyclerView$u0;->isInvalid()Z

    move-result p3

    if-nez p3, :cond_1

    iget-object p3, p2, Landroidx/recyclerview/widget/RecyclerView$u0;->itemView:Landroid/view/View;

    invoke-virtual {p0, p3}, Landroidx/recyclerview/widget/RecyclerView$i0;->G(Landroid/view/View;)V
    ...
    :cond_1
    invoke-virtual {p0, p2, v0}, Landroidx/recyclerview/widget/RecyclerView$i0;->a(Landroidx/recyclerview/widget/RecyclerView$u0;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :cond_2
    :goto_0
    invoke-virtual {p1, v0}, Landroidx/recyclerview/widget/RecyclerView;->G2(Z)V
