...
.field public static final enum b:Landroidx/recyclerview/widget/ConcatAdapter$Config$StableIdMode;

.field public static final enum c:Landroidx/recyclerview/widget/ConcatAdapter$Config$StableIdMode;

.field public static final synthetic d:[Landroidx/recyclerview/widget/ConcatAdapter$Config$StableIdMode;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/recyclerview/widget/ConcatAdapter$Config$StableIdMode;->b:Landroidx/recyclerview/widget/ConcatAdapter$Config$StableIdMode;
    ...
    sput-object v0, Landroidx/recyclerview/widget/ConcatAdapter$Config$StableIdMode;->c:Landroidx/recyclerview/widget/ConcatAdapter$Config$StableIdMode;

    invoke-static {}, Landroidx/recyclerview/widget/ConcatAdapter$Config$StableIdMode;->a()[Landroidx/recyclerview/widget/ConcatAdapter$Config$StableIdMode;

    move-result-object v0

    sput-object v0, Landroidx/recyclerview/widget/ConcatAdapter$Config$StableIdMode;->d:[Landroidx/recyclerview/widget/ConcatAdapter$Config$StableIdMode;
...
.method public static synthetic a()[Landroidx/recyclerview/widget/ConcatAdapter$Config$StableIdMode;
    .locals 3
    ...
    sget-object v1, Landroidx/recyclerview/widget/ConcatAdapter$Config$StableIdMode;->b:Landroidx/recyclerview/widget/ConcatAdapter$Config$StableIdMode;

    sget-object v2, Landroidx/recyclerview/widget/ConcatAdapter$Config$StableIdMode;->c:Landroidx/recyclerview/widget/ConcatAdapter$Config$StableIdMode;
...
.method public static values()[Landroidx/recyclerview/widget/ConcatAdapter$Config$StableIdMode;
    ...
    sget-object v0, Landroidx/recyclerview/widget/ConcatAdapter$Config$StableIdMode;->d:[Landroidx/recyclerview/widget/ConcatAdapter$Config$StableIdMode;
