...
.method public a(IIII)Landroid/view/View;
    ...
    invoke-interface {v0}, Landroidx/recyclerview/widget/h0$b;->c()I

    move-result v0

    iget-object v1, p0, Landroidx/recyclerview/widget/h0;->a:Landroidx/recyclerview/widget/h0$b;

    invoke-interface {v1}, Landroidx/recyclerview/widget/h0$b;->d()I
    ...
    invoke-interface {v4, p1}, Landroidx/recyclerview/widget/h0$b;->a(I)Landroid/view/View;

    move-result-object v4

    iget-object v5, p0, Landroidx/recyclerview/widget/h0;->a:Landroidx/recyclerview/widget/h0$b;

    invoke-interface {v5, v4}, Landroidx/recyclerview/widget/h0$b;->b(Landroid/view/View;)I
    ...
    invoke-virtual {v7, v0, v1, v5, v6}, Landroidx/recyclerview/widget/h0$a;->e(IIII)V

    if-eqz p3, :cond_1

    iget-object v5, p0, Landroidx/recyclerview/widget/h0;->b:Landroidx/recyclerview/widget/h0$a;

    invoke-virtual {v5}, Landroidx/recyclerview/widget/h0$a;->d()V

    iget-object v5, p0, Landroidx/recyclerview/widget/h0;->b:Landroidx/recyclerview/widget/h0$a;

    invoke-virtual {v5, p3}, Landroidx/recyclerview/widget/h0$a;->a(I)V

    iget-object v5, p0, Landroidx/recyclerview/widget/h0;->b:Landroidx/recyclerview/widget/h0$a;

    invoke-virtual {v5}, Landroidx/recyclerview/widget/h0$a;->b()Z
    ...
    invoke-virtual {v5, p4}, Landroidx/recyclerview/widget/h0$a;->a(I)V
...
.method public b(Landroid/view/View;I)Z
    ...
    invoke-interface {v2}, Landroidx/recyclerview/widget/h0$b;->d()I

    move-result v2

    iget-object v3, p0, Landroidx/recyclerview/widget/h0;->a:Landroidx/recyclerview/widget/h0$b;

    invoke-interface {v3, p1}, Landroidx/recyclerview/widget/h0$b;->b(Landroid/view/View;)I
    ...
    invoke-virtual {v0, v1, v2, v3, p1}, Landroidx/recyclerview/widget/h0$a;->e(IIII)V

    if-eqz p2, :cond_0

    iget-object p1, p0, Landroidx/recyclerview/widget/h0;->b:Landroidx/recyclerview/widget/h0$a;

    invoke-virtual {p1}, Landroidx/recyclerview/widget/h0$a;->d()V

    iget-object p1, p0, Landroidx/recyclerview/widget/h0;->b:Landroidx/recyclerview/widget/h0$a;

    invoke-virtual {p1, p2}, Landroidx/recyclerview/widget/h0$a;->a(I)V

    iget-object p0, p0, Landroidx/recyclerview/widget/h0;->b:Landroidx/recyclerview/widget/h0$a;

    invoke-virtual {p0}, Landroidx/recyclerview/widget/h0$a;->b()Z
