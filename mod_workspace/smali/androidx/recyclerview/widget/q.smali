...
.super Landroidx/recyclerview/widget/RecyclerView$p0;
.source "SourceFile"
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0}, Landroidx/recyclerview/widget/RecyclerView$p0;-><init>()V
...
.method public final A()F
    ...
    invoke-virtual {p0, v0}, Landroidx/recyclerview/widget/q;->v(Landroid/util/DisplayMetrics;)F
    ...
    :cond_0
    iget p0, p0, Landroidx/recyclerview/widget/q;->n:F
...
.method public B()I
    ...
    iget-object p0, p0, Landroidx/recyclerview/widget/q;->k:Landroid/graphics/PointF;
...
.method public C(Landroidx/recyclerview/widget/RecyclerView$p0$a;)V
    .locals 4
    ...
    invoke-virtual {p0, v0}, Landroidx/recyclerview/widget/RecyclerView$p0;->a(I)Landroid/graphics/PointF;
    ...
    :cond_0
    invoke-virtual {p0, v0}, Landroidx/recyclerview/widget/RecyclerView$p0;->i(Landroid/graphics/PointF;)V
    ...
    iput v1, p0, Landroidx/recyclerview/widget/q;->o:I
    ...
    iget v1, p0, Landroidx/recyclerview/widget/q;->o:I
    ...
    iget v3, p0, Landroidx/recyclerview/widget/q;->p:I
    ...
    iget-object p0, p0, Landroidx/recyclerview/widget/q;->i:Landroid/view/animation/LinearInterpolator;

    invoke-virtual {p1, v1, v3, v0, p0}, Landroidx/recyclerview/widget/RecyclerView$p0$a;->d(IIILandroid/view/animation/Interpolator;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/recyclerview/widget/RecyclerView$p0$a;->b(I)V
...
.method public l(IILandroidx/recyclerview/widget/RecyclerView$q0;Landroidx/recyclerview/widget/RecyclerView$p0$a;)V
    .locals 0

    invoke-virtual {p0}, Landroidx/recyclerview/widget/RecyclerView$p0;->c()I
    ...
    :cond_0
    iget p3, p0, Landroidx/recyclerview/widget/q;->o:I

    invoke-virtual {p0, p3, p1}, Landroidx/recyclerview/widget/q;->y(II)I

    move-result p1

    iput p1, p0, Landroidx/recyclerview/widget/q;->o:I

    iget p1, p0, Landroidx/recyclerview/widget/q;->p:I

    invoke-virtual {p0, p1, p2}, Landroidx/recyclerview/widget/q;->y(II)I
    ...
    invoke-virtual {p0, p4}, Landroidx/recyclerview/widget/q;->C(Landroidx/recyclerview/widget/RecyclerView$p0$a;)V
...
.method public t(Landroid/view/View;I)I
    ...
    invoke-virtual {v0, p1}, Landroidx/recyclerview/widget/RecyclerView$b0;->g0(Landroid/view/View;)I
    ...
    invoke-virtual {v0, p1}, Landroidx/recyclerview/widget/RecyclerView$b0;->j0(Landroid/view/View;)I
    ...
    invoke-virtual {v0}, Landroidx/recyclerview/widget/RecyclerView$b0;->z0()I
    ...
    invoke-virtual/range {v4 .. v9}, Landroidx/recyclerview/widget/q;->s(IIIII)I
...
.method public u(Landroid/view/View;I)I
    ...
    invoke-virtual {v0, p1}, Landroidx/recyclerview/widget/RecyclerView$b0;->k0(Landroid/view/View;)I
    ...
    invoke-virtual {v0, p1}, Landroidx/recyclerview/widget/RecyclerView$b0;->e0(Landroid/view/View;)I
    ...
    invoke-virtual {v0}, Landroidx/recyclerview/widget/RecyclerView$b0;->getPaddingBottom()I
...
.method public w(I)I
    ...
    invoke-virtual {p0, p1}, Landroidx/recyclerview/widget/q;->x(I)I
...
.method public x(I)I
    ...
    invoke-virtual {p0}, Landroidx/recyclerview/widget/q;->A()F
