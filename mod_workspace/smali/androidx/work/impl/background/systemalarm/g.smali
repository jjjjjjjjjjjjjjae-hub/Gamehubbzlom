...
.field public final c:Landroidx/work/impl/utils/d0;
...
.field public i:Landroidx/work/impl/background/systemalarm/g$c;

.field public j:Landroidx/work/impl/a0;

.field public final k:Landroidx/work/impl/s0;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 1
    invoke-direct {p0, p1, v0, v0, v0}, Landroidx/work/impl/background/systemalarm/g;-><init>(Landroid/content/Context;Landroidx/work/impl/t;Landroidx/work/impl/w0;Landroidx/work/impl/s0;)V

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Landroidx/work/impl/t;Landroidx/work/impl/w0;Landroidx/work/impl/s0;)V
    .locals 3
    ...
    iput-object v1, p0, Landroidx/work/impl/background/systemalarm/g;->j:Landroidx/work/impl/a0;
    ...
    :goto_0
    iput-object p3, p0, Landroidx/work/impl/background/systemalarm/g;->e:Landroidx/work/impl/w0;

    .line 6
    new-instance p1, Landroidx/work/impl/background/systemalarm/b;

    .line 7
    invoke-virtual {p3}, Landroidx/work/impl/w0;->m()Landroidx/work/b;
    ...
    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/g;->j:Landroidx/work/impl/a0;

    invoke-direct {p1, v0, v1, v2}, Landroidx/work/impl/background/systemalarm/b;-><init>(Landroid/content/Context;Landroidx/work/a;Landroidx/work/impl/a0;)V
    ...
    invoke-virtual {v0}, Landroidx/work/b;->k()Landroidx/work/c0;

    move-result-object v0

    invoke-direct {p1, v0}, Landroidx/work/impl/utils/d0;-><init>(Landroidx/work/c0;)V

    iput-object p1, p0, Landroidx/work/impl/background/systemalarm/g;->c:Landroidx/work/impl/utils/d0;
    ...
    .line 9
    :cond_1
    invoke-virtual {p3}, Landroidx/work/impl/w0;->q()Landroidx/work/impl/t;

    move-result-object p2

    :goto_1
    iput-object p2, p0, Landroidx/work/impl/background/systemalarm/g;->d:Landroidx/work/impl/t;

    .line 10
    invoke-virtual {p3}, Landroidx/work/impl/w0;->u()Landroidx/work/impl/utils/taskexecutor/b;
    ...
    .line 11
    :cond_2
    new-instance p4, Landroidx/work/impl/u0;

    invoke-direct {p4, p2, p1}, Landroidx/work/impl/u0;-><init>(Landroidx/work/impl/t;Landroidx/work/impl/utils/taskexecutor/b;)V

    :goto_2
    iput-object p4, p0, Landroidx/work/impl/background/systemalarm/g;->k:Landroidx/work/impl/s0;
...
.method public a(Landroid/content/Intent;I)Z
    ...
    invoke-virtual {p0}, Landroidx/work/impl/background/systemalarm/g;->b()V
    ...
    invoke-virtual {p0, v0}, Landroidx/work/impl/background/systemalarm/g;->j(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0}, Landroidx/work/impl/background/systemalarm/g;->l()V
...
.method public c(Landroidx/work/impl/model/m;Z)V
    ...
    invoke-static {v2, p1, p2}, Landroidx/work/impl/background/systemalarm/b;->d(Landroid/content/Context;Landroidx/work/impl/model/m;Z)Landroid/content/Intent;
...
.method public d()V
    ...
    invoke-virtual {v2, v1, v3}, Landroidx/work/r;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    :goto_0
    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/g;->b:Landroidx/work/impl/utils/taskexecutor/b;
    ...
    invoke-interface {v2}, Landroidx/work/impl/utils/taskexecutor/a;->P()Z
    ...
    iget-object p0, p0, Landroidx/work/impl/background/systemalarm/g;->i:Landroidx/work/impl/background/systemalarm/g$c;

    if-eqz p0, :cond_3

    invoke-interface {p0}, Landroidx/work/impl/background/systemalarm/g$c;->b()V
...
.method public e()Landroidx/work/impl/t;
    ...
    iget-object p0, p0, Landroidx/work/impl/background/systemalarm/g;->d:Landroidx/work/impl/t;

    return-object p0
.end method

.method public f()Landroidx/work/impl/utils/taskexecutor/b;
    .locals 0

    iget-object p0, p0, Landroidx/work/impl/background/systemalarm/g;->b:Landroidx/work/impl/utils/taskexecutor/b;

    return-object p0
.end method

.method public g()Landroidx/work/impl/w0;
    .locals 0

    iget-object p0, p0, Landroidx/work/impl/background/systemalarm/g;->e:Landroidx/work/impl/w0;

    return-object p0
.end method

.method public h()Landroidx/work/impl/utils/d0;
    .locals 0

    iget-object p0, p0, Landroidx/work/impl/background/systemalarm/g;->c:Landroidx/work/impl/utils/d0;

    return-object p0
.end method

.method public i()Landroidx/work/impl/s0;
    .locals 0

    iget-object p0, p0, Landroidx/work/impl/background/systemalarm/g;->k:Landroidx/work/impl/s0;
...
.method public final j(Ljava/lang/String;)Z
    ...
    :try_start_0
    iget-object p0, p0, Landroidx/work/impl/background/systemalarm/g;->g:Ljava/util/List;
...
.method public k()V
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/g;->d:Landroidx/work/impl/t;
...
.method public final l()V
    ...
    invoke-static {v0, v1}, Landroidx/work/impl/utils/w;->b(Landroid/content/Context;Ljava/lang/String;)Landroid/os/PowerManager$WakeLock;
    ...
    invoke-virtual {v1}, Landroidx/work/impl/w0;->u()Landroidx/work/impl/utils/taskexecutor/b;
    ...
    invoke-interface {v1, v2}, Landroidx/work/impl/utils/taskexecutor/b;->d(Ljava/lang/Runnable;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public m(Landroidx/work/impl/background/systemalarm/g$c;)V
    .locals 1
    ...
    sget-object p1, Landroidx/work/impl/background/systemalarm/g;->l:Ljava/lang/String;
