...
.method public static synthetic a(Landroidx/sqlite/db/j;Landroid/database/sqlite/SQLiteDatabase;Landroid/database/sqlite/SQLiteCursorDriver;Ljava/lang/String;Landroid/database/sqlite/SQLiteQuery;)Landroid/database/Cursor;
    ...
    invoke-static {p0, p1, p2, p3, p4}, Landroidx/sqlite/db/framework/FrameworkSQLiteDatabase;->e(Landroidx/sqlite/db/j;Landroid/database/sqlite/SQLiteDatabase;Landroid/database/sqlite/SQLiteCursorDriver;Ljava/lang/String;Landroid/database/sqlite/SQLiteQuery;)Landroid/database/Cursor;
...
.method public static synthetic b(Lkotlin/jvm/functions/r;Landroid/database/sqlite/SQLiteDatabase;Landroid/database/sqlite/SQLiteCursorDriver;Ljava/lang/String;Landroid/database/sqlite/SQLiteQuery;)Landroid/database/Cursor;
    ...
    invoke-static {p0, p1, p2, p3, p4}, Landroidx/sqlite/db/framework/FrameworkSQLiteDatabase;->d(Lkotlin/jvm/functions/r;Landroid/database/sqlite/SQLiteDatabase;Landroid/database/sqlite/SQLiteCursorDriver;Ljava/lang/String;Landroid/database/sqlite/SQLiteQuery;)Landroid/database/Cursor;
...
.method public static final d(Lkotlin/jvm/functions/r;Landroid/database/sqlite/SQLiteDatabase;Landroid/database/sqlite/SQLiteCursorDriver;Ljava/lang/String;Landroid/database/sqlite/SQLiteQuery;)Landroid/database/Cursor;
    ...
    invoke-interface {p0, p1, p2, p3, p4}, Lkotlin/jvm/functions/r;->g(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public A1(Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-virtual {p0, v0}, Landroidx/sqlite/db/framework/FrameworkSQLiteDatabase;->C0(Landroidx/sqlite/db/j;)Landroid/database/Cursor;
...
.method public C0(Landroidx/sqlite/db/j;)Landroid/database/Cursor;
    ...
    invoke-direct {v0, p1}, Landroidx/sqlite/db/framework/FrameworkSQLiteDatabase$query$cursorFactory$1;-><init>(Landroidx/sqlite/db/j;)V
...
.method public Y(Landroidx/sqlite/db/j;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
    ...
    invoke-static/range {v1 .. v6}, Landroidx/sqlite/db/b;->e(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Landroid/os/CancellationSignal;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;)Landroid/database/Cursor;
...
.method public h1(Ljava/lang/String;)Landroidx/sqlite/db/k;
    ...
    invoke-direct {v0, p0}, Landroidx/sqlite/db/framework/f;-><init>(Landroid/database/sqlite/SQLiteStatement;)V
...
.method public t1(Ljava/lang/String;ILandroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    invoke-virtual {p0, p1}, Landroidx/sqlite/db/framework/FrameworkSQLiteDatabase;->h1(Ljava/lang/String;)Landroidx/sqlite/db/k;

    move-result-object p0

    sget-object p1, Landroidx/sqlite/db/a;->c:Landroidx/sqlite/db/a$a;

    invoke-virtual {p1, p0, v2}, Landroidx/sqlite/db/a$a;->b(Landroidx/sqlite/db/i;[Ljava/lang/Object;)V
