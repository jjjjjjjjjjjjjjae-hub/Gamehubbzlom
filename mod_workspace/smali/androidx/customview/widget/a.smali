...
.method public constructor <init>(Landroid/view/View;)V
    ...
    invoke-static {p1, p0}, Landroidx/core/view/t0;->q0(Landroid/view/View;I)V
...
.method public final A(ILandroid/graphics/Rect;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/customview/widget/a;->I(I)Landroidx/core/view/accessibility/d;

    move-result-object p0

    invoke-virtual {p0, p2}, Landroidx/core/view/accessibility/d;->j(Landroid/graphics/Rect;)V
...
.method public final H(ILandroid/graphics/Rect;)Z
    ...
    invoke-virtual {p0}, Landroidx/customview/widget/a;->z()Landroidx/collection/l;
    ...
    :cond_0
    invoke-virtual {v7, v0}, Landroidx/collection/l;->f(I)Ljava/lang/Object;
    ...
    invoke-static {p2, p1, v4}, Landroidx/customview/widget/a;->E(Landroid/view/View;ILandroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    :cond_7
    invoke-virtual {v7, p1}, Landroidx/collection/l;->h(Ljava/lang/Object;)I

    move-result p1

    invoke-virtual {v7, p1}, Landroidx/collection/l;->j(I)I

    move-result v8

    :goto_6
    invoke-virtual {p0, v8}, Landroidx/customview/widget/a;->U(I)Z
...
.method public I(I)Landroidx/core/view/accessibility/d;
    .locals 1
...
.method public final J(ZILandroid/graphics/Rect;)V
    ...
    invoke-virtual {p0, p2, p3}, Landroidx/customview/widget/a;->H(ILandroid/graphics/Rect;)Z
...
.method public abstract N(Landroidx/core/view/accessibility/d;)V
.end method

.method public abstract O(ILandroidx/core/view/accessibility/d;)V
.end method
...
.method public Q(IILandroid/os/Bundle;)Z
    ...
    invoke-virtual {p0, p1, p2, p3}, Landroidx/customview/widget/a;->R(IILandroid/os/Bundle;)Z
    ...
    :cond_0
    invoke-virtual {p0, p2, p3}, Landroidx/customview/widget/a;->S(ILandroid/os/Bundle;)Z
...
.method public final R(IILandroid/os/Bundle;)Z
    ...
    invoke-virtual {p0, p1, p2, p3}, Landroidx/customview/widget/a;->K(IILandroid/os/Bundle;)Z
    ...
    :cond_1
    invoke-virtual {p0, p1}, Landroidx/customview/widget/a;->T(I)Z
    ...
    :cond_3
    invoke-virtual {p0, p1}, Landroidx/customview/widget/a;->U(I)Z
...
.method public final S(ILandroid/os/Bundle;)Z
    ...
    invoke-static {p0, p1, p2}, Landroidx/core/view/t0;->W(Landroid/view/View;ILandroid/os/Bundle;)Z
...
.method public final T(I)Z
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/customview/widget/a;->V(II)Z
...
.method public final U(I)Z
    ...
    invoke-virtual {p0, p1, v1}, Landroidx/customview/widget/a;->V(II)Z
...
.method public final W(I)V
    ...
    invoke-virtual {p0, v0, p1}, Landroidx/customview/widget/a;->V(II)Z
...
.method public f(Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    invoke-virtual {p0, p2}, Landroidx/customview/widget/a;->L(Landroid/view/accessibility/AccessibilityEvent;)V
...
.method public g(Landroid/view/View;Landroidx/core/view/accessibility/d;)V
    ...
    invoke-virtual {p0, p2}, Landroidx/customview/widget/a;->N(Landroidx/core/view/accessibility/d;)V
...
.method public final q()Z
    ...
    invoke-virtual {p0, v0, v1, v2}, Landroidx/customview/widget/a;->K(IILandroid/os/Bundle;)Z
...
.method public final s(II)Landroid/view/accessibility/AccessibilityEvent;
    ...
    invoke-virtual {v0}, Landroidx/core/view/accessibility/d;->M()Z
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/customview/widget/a;->M(ILandroid/view/accessibility/AccessibilityEvent;)V
...
.method public final u(I)Landroidx/core/view/accessibility/d;
    ...
    invoke-static {}, Landroidx/core/view/accessibility/d;->S()Landroidx/core/view/accessibility/d;
    ...
    invoke-virtual {v0, v1}, Landroidx/core/view/accessibility/d;->l0(Z)V

    const-string v2, "android.view.View"

    invoke-virtual {v0, v2}, Landroidx/core/view/accessibility/d;->d0(Ljava/lang/CharSequence;)V

    sget-object v2, Landroidx/customview/widget/a;->n:Landroid/graphics/Rect;

    invoke-virtual {v0, v2}, Landroidx/core/view/accessibility/d;->Z(Landroid/graphics/Rect;)V

    invoke-virtual {v0, v2}, Landroidx/core/view/accessibility/d;->a0(Landroid/graphics/Rect;)V

    iget-object v3, p0, Landroidx/customview/widget/a;->i:Landroid/view/View;

    invoke-virtual {v0, v3}, Landroidx/core/view/accessibility/d;->t0(Landroid/view/View;)V

    invoke-virtual {p0, p1, v0}, Landroidx/customview/widget/a;->O(ILandroidx/core/view/accessibility/d;)V
    ...
    invoke-virtual {v0, v3}, Landroidx/core/view/accessibility/d;->j(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0, v3}, Landroidx/core/view/accessibility/d;->r0(Ljava/lang/CharSequence;)V

    iget-object v3, p0, Landroidx/customview/widget/a;->i:Landroid/view/View;

    invoke-virtual {v0, v3, p1}, Landroidx/core/view/accessibility/d;->z0(Landroid/view/View;I)V
    ...
    :cond_2
    invoke-virtual {v0, v5}, Landroidx/core/view/accessibility/d;->Y(Z)V
    ...
    :cond_5
    :goto_3
    invoke-virtual {v0, p1}, Landroidx/core/view/accessibility/d;->m0(Z)V
    ...
    invoke-virtual {p1, v4, v2}, Landroidx/core/view/accessibility/d;->u0(Landroid/view/View;I)V

    sget-object v4, Landroidx/customview/widget/a;->n:Landroid/graphics/Rect;

    invoke-virtual {p1, v4}, Landroidx/core/view/accessibility/d;->Z(Landroid/graphics/Rect;)V

    invoke-virtual {p0, v3, p1}, Landroidx/customview/widget/a;->O(ILandroidx/core/view/accessibility/d;)V

    iget-object v3, p0, Landroidx/customview/widget/a;->e:Landroid/graphics/Rect;

    invoke-virtual {p1, v3}, Landroidx/core/view/accessibility/d;->j(Landroid/graphics/Rect;)V
    ...
    :cond_6
    invoke-virtual {p1}, Landroidx/core/view/accessibility/d;->W()V
    ...
    invoke-virtual {v0, p1}, Landroidx/core/view/accessibility/d;->a0(Landroid/graphics/Rect;)V

    iget-object p1, p0, Landroidx/customview/widget/a;->d:Landroid/graphics/Rect;

    invoke-virtual {p0, p1}, Landroidx/customview/widget/a;->F(Landroid/graphics/Rect;)Z

    move-result p0

    if-eqz p0, :cond_9

    invoke-virtual {v0, v1}, Landroidx/core/view/accessibility/d;->D0(Z)V
...
.method public final v()Landroidx/core/view/accessibility/d;
    ...
    invoke-static {v0}, Landroidx/core/view/accessibility/d;->T(Landroid/view/View;)Landroidx/core/view/accessibility/d;

    move-result-object v0

    iget-object v1, p0, Landroidx/customview/widget/a;->i:Landroid/view/View;

    invoke-static {v1, v0}, Landroidx/core/view/t0;->U(Landroid/view/View;Landroidx/core/view/accessibility/d;)V

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    invoke-virtual {p0, v1}, Landroidx/customview/widget/a;->D(Ljava/util/List;)V
...
.method public final w(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0, v4}, Landroidx/customview/widget/a;->W(I)V
    ...
    invoke-virtual {p0, v0, p1}, Landroidx/customview/widget/a;->C(FF)I

    move-result p1

    invoke-virtual {p0, p1}, Landroidx/customview/widget/a;->W(I)V
...
.method public final x(Landroid/view/KeyEvent;)Z
    ...
    invoke-static {v0}, Landroidx/customview/widget/a;->G(I)I
    ...
    invoke-virtual {p0, v0, v4}, Landroidx/customview/widget/a;->H(ILandroid/graphics/Rect;)Z
    ...
    invoke-virtual {p0, p1, v4}, Landroidx/customview/widget/a;->H(ILandroid/graphics/Rect;)Z
    ...
    invoke-virtual {p0, v2, v4}, Landroidx/customview/widget/a;->H(ILandroid/graphics/Rect;)Z
...
.method public final z()Landroidx/collection/l;
    ...
    invoke-virtual {p0, v0}, Landroidx/customview/widget/a;->D(Ljava/util/List;)V
    ...
    invoke-virtual {v1, v4, v3}, Landroidx/collection/l;->k(ILjava/lang/Object;)V
