.class public Lorg/simpleframework/xml/core/r;
...
.method public constructor <init>(Lorg/simpleframework/xml/core/a0;Lorg/simpleframework/xml/core/n0;Lorg/simpleframework/xml/strategy/f;)V
    ...
    iput-object v0, p0, Lorg/simpleframework/xml/core/r;->b:Lorg/simpleframework/xml/core/f3;

    invoke-interface {p1}, Lorg/simpleframework/xml/core/a0;->d()Lorg/simpleframework/xml/stream/Style;

    move-result-object v0

    iput-object v0, p0, Lorg/simpleframework/xml/core/r;->c:Lorg/simpleframework/xml/stream/Style;

    iput-object p1, p0, Lorg/simpleframework/xml/core/r;->a:Lorg/simpleframework/xml/core/a0;

    iput-object p2, p0, Lorg/simpleframework/xml/core/r;->d:Lorg/simpleframework/xml/core/n0;

    iput-object p3, p0, Lorg/simpleframework/xml/core/r;->e:Lorg/simpleframework/xml/strategy/f;
...
.method public a(Lorg/simpleframework/xml/stream/InputNode;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v1, p0, Lorg/simpleframework/xml/core/r;->e:Lorg/simpleframework/xml/strategy/f;
    ...
    invoke-virtual {p0, p1}, Lorg/simpleframework/xml/core/r;->b(Lorg/simpleframework/xml/stream/InputNode;)Ljava/lang/Object;
    ...
    iget-object p0, p0, Lorg/simpleframework/xml/core/r;->d:Lorg/simpleframework/xml/core/n0;
...
.method public b(Lorg/simpleframework/xml/stream/InputNode;)Ljava/lang/Object;
    ...
    iget-object v2, p0, Lorg/simpleframework/xml/core/r;->d:Lorg/simpleframework/xml/core/n0;

    invoke-virtual {v2}, Lorg/simpleframework/xml/core/n0;->c()Ljava/lang/String;

    move-result-object v2

    if-nez v2, :cond_0

    iget-object v2, p0, Lorg/simpleframework/xml/core/r;->a:Lorg/simpleframework/xml/core/a0;

    invoke-interface {v2, v1}, Lorg/simpleframework/xml/core/a0;->k(Ljava/lang/Class;)Ljava/lang/String;

    move-result-object v2

    :cond_0
    iget-object v3, p0, Lorg/simpleframework/xml/core/r;->d:Lorg/simpleframework/xml/core/n0;

    invoke-virtual {v3}, Lorg/simpleframework/xml/core/n0;->i()Z

    move-result v3

    if-nez v3, :cond_1

    invoke-virtual {p0, p1, v2}, Lorg/simpleframework/xml/core/r;->d(Lorg/simpleframework/xml/stream/InputNode;Ljava/lang/String;)Ljava/lang/Object;
...
.method public c(Lorg/simpleframework/xml/stream/OutputNode;Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lorg/simpleframework/xml/core/r;->e:Lorg/simpleframework/xml/strategy/f;

    invoke-interface {v0}, Lorg/simpleframework/xml/strategy/f;->getType()Ljava/lang/Class;

    move-result-object v0

    iget-object v1, p0, Lorg/simpleframework/xml/core/r;->d:Lorg/simpleframework/xml/core/n0;
    ...
    invoke-virtual {v2}, Lorg/simpleframework/xml/core/n0;->i()Z
    ...
    iget-object v1, p0, Lorg/simpleframework/xml/core/r;->a:Lorg/simpleframework/xml/core/a0;
    ...
    :cond_0
    iget-object v2, p0, Lorg/simpleframework/xml/core/r;->c:Lorg/simpleframework/xml/stream/Style;

    invoke-interface {v2, v1}, Lorg/simpleframework/xml/stream/Style;->getElement(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iget-object p0, p0, Lorg/simpleframework/xml/core/r;->b:Lorg/simpleframework/xml/core/f3;
...
.method public final d(Lorg/simpleframework/xml/stream/InputNode;Ljava/lang/String;)Ljava/lang/Object;
    .locals 2

    iget-object v0, p0, Lorg/simpleframework/xml/core/r;->c:Lorg/simpleframework/xml/stream/Style;
