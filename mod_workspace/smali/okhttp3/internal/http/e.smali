.class public abstract Lokhttp3/internal/http/e;
...
.method public static final a(Lokhttp3/s;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {p1, v3, v4}, Lkotlin/text/q;->v(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v3, v4}, Lokio/d;->B0(Ljava/lang/String;)Lokio/d;

    move-result-object v3

    :try_start_0
    invoke-static {v3, v0}, Lokhttp3/internal/http/e;->c(Lokio/d;Ljava/util/List;)V
    :try_end_0
    ...
    invoke-virtual {v4, v5, v6, v3}, Lokhttp3/internal/platform/h;->j(Ljava/lang/String;ILjava/lang/Throwable;)V
...
.method public static final b(Lokhttp3/a0;)Z
    ...
    :cond_2
    invoke-static {p0}, Lokhttp3/internal/b;->s(Lokhttp3/a0;)J
    ...
    invoke-static {p0, v0, v4, v2, v4}, Lokhttp3/a0;->l(Lokhttp3/a0;Ljava/lang/String;Ljava/lang/String;ILjava/lang/Object;)Ljava/lang/String;

    move-result-object p0

    const-string v0, "chunked"

    invoke-static {v0, p0, v3}, Lkotlin/text/q;->v(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method public static final c(Lokio/d;Ljava/util/List;)V
    .locals 7
    ...
    invoke-static {p0}, Lokhttp3/internal/http/e;->g(Lokio/d;)Z

    invoke-static {p0}, Lokhttp3/internal/http/e;->e(Lokio/d;)Ljava/lang/String;
    ...
    invoke-static {p0, v4}, Lokhttp3/internal/b;->G(Lokio/d;B)I
    ...
    invoke-static {v3, v5}, Lkotlin/text/q;->y(Ljava/lang/CharSequence;I)Ljava/lang/String;
    ...
    invoke-static {p0, v6}, Lokhttp3/internal/http/e;->h(Lokio/d;B)Z

    move-result v6

    if-eqz v6, :cond_a

    invoke-static {p0}, Lokhttp3/internal/http/e;->d(Lokio/d;)Ljava/lang/String;
...
.method public static final d(Lokio/d;)Ljava/lang/String;
    .locals 12
    ...
    invoke-virtual {p0, v2}, Lokio/d;->e0(Lokio/ByteString;)J
    ...
    invoke-virtual {v0, p0, v2, v3}, Lokio/d;->u0(Lokio/d;J)V
    ...
    invoke-virtual {v0, p0, v8, v9}, Lokio/d;->u0(Lokio/d;J)V
...
.method public static final e(Lokio/d;)Ljava/lang/String;
    .locals 4

    sget-object v0, Lokhttp3/internal/http/e;->b:Lokio/ByteString;

    invoke-virtual {p0, v0}, Lokio/d;->e0(Lokio/ByteString;)J
...
.method public static final g(Lokio/d;)Z
    .locals 3
...
.method public static final h(Lokio/d;B)Z
    .locals 2
