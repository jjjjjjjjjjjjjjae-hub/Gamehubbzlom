...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;JJ)V
    ...
    invoke-static {p2}, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHttpClient;->e(Ljava/lang/String;)Ljava/lang/String;
...
.method public static d(Lorg/json/JSONObject;Ljava/util/Date;)Lcom/google/firebase/remoteconfig/internal/f;
    .locals 2
    ...
    invoke-virtual {v0, p1}, Lcom/google/firebase/remoteconfig/internal/f$b;->d(Ljava/util/Date;)Lcom/google/firebase/remoteconfig/internal/f$b;
    ...
    :try_start_4
    invoke-virtual {p1, v1}, Lcom/google/firebase/remoteconfig/internal/f$b;->c(Lorg/json/JSONArray;)Lcom/google/firebase/remoteconfig/internal/f$b;
    :try_end_4
    ...
    :try_start_6
    invoke-virtual {p1, v0}, Lcom/google/firebase/remoteconfig/internal/f$b;->e(Lorg/json/JSONObject;)Lcom/google/firebase/remoteconfig/internal/f$b;
...
.method public final b(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)Lorg/json/JSONObject;
    .locals 2
...
.method public c()Ljava/net/HttpURLConnection;
    ...
    invoke-virtual {p0, v1, v2}, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHttpClient;->g(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final f(Ljava/net/URLConnection;)Lorg/json/JSONObject;
    .locals 2
...
.method public fetch(Ljava/net/HttpURLConnection;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;Ljava/util/Date;)Lcom/google/firebase/remoteconfig/internal/k$a;
    .locals 0
    ...
    invoke-virtual {p0, p1, p5, p3, p6}, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHttpClient;->l(Ljava/net/HttpURLConnection;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V

    :try_start_0
    invoke-virtual {p0, p2, p3, p4}, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHttpClient;->b(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)Lorg/json/JSONObject;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHttpClient;->k(Ljava/net/HttpURLConnection;[B)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHttpClient;->f(Ljava/net/URLConnection;)Lorg/json/JSONObject;
    ...
    :cond_0
    invoke-static {p3, p7}, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHttpClient;->d(Lorg/json/JSONObject;Ljava/util/Date;)Lcom/google/firebase/remoteconfig/internal/f;

    move-result-object p0

    invoke-static {p0, p2}, Lcom/google/firebase/remoteconfig/internal/k$a;->b(Lcom/google/firebase/remoteconfig/internal/f;Ljava/lang/String;)Lcom/google/firebase/remoteconfig/internal/k$a;
...
.method public final i(Ljava/net/HttpURLConnection;Ljava/lang/String;)V
    .locals 2
    ...
    invoke-virtual {p0}, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHttpClient;->h()Ljava/lang/String;
...
.method public final j(Ljava/net/HttpURLConnection;Ljava/util/Map;)V
    .locals 1
...
.method public final k(Ljava/net/HttpURLConnection;[B)V
    .locals 0
...
.method public final l(Ljava/net/HttpURLConnection;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    .locals 3
    ...
    invoke-virtual {p0, p1, p3}, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHttpClient;->i(Ljava/net/HttpURLConnection;Ljava/lang/String;)V

    invoke-virtual {p0, p1, p4}, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHttpClient;->j(Ljava/net/HttpURLConnection;Ljava/util/Map;)V
