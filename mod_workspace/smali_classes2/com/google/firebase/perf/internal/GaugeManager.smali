...
.field private final cpuGaugeCollector:Lcom/google/firebase/perf/gauges/c;
...
.field private final memoryGaugeCollector:Lcom/google/firebase/perf/gauges/f;

.field private sessionId:Ljava/lang/String;

.field private final transportManager:Lcom/google/firebase/perf/transport/l;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/firebase/perf/internal/GaugeManager;->logger:Lcom/google/firebase/perf/logging/a;
...
.method private constructor <init>()V
    ...
    .line 4
    invoke-static {}, Lcom/google/firebase/perf/gauges/c;->d()Lcom/google/firebase/perf/gauges/c;

    move-result-object v5

    .line 5
    invoke-static {}, Lcom/google/firebase/perf/gauges/f;->c()Lcom/google/firebase/perf/gauges/f;
    ...
    .line 6
    invoke-direct/range {v0 .. v6}, Lcom/google/firebase/perf/internal/GaugeManager;-><init>(Ljava/util/concurrent/ScheduledExecutorService;Lcom/google/firebase/perf/transport/l;Lcom/google/firebase/perf/config/a;Lcom/google/firebase/perf/internal/i;Lcom/google/firebase/perf/gauges/c;Lcom/google/firebase/perf/gauges/f;)V

    return-void
.end method

.method public constructor <init>(Ljava/util/concurrent/ScheduledExecutorService;Lcom/google/firebase/perf/transport/l;Lcom/google/firebase/perf/config/a;Lcom/google/firebase/perf/internal/i;Lcom/google/firebase/perf/gauges/c;Lcom/google/firebase/perf/gauges/f;)V
    .locals 1
    ...
    .line 12
    iput-object p2, p0, Lcom/google/firebase/perf/internal/GaugeManager;->transportManager:Lcom/google/firebase/perf/transport/l;
    ...
    .line 15
    iput-object p5, p0, Lcom/google/firebase/perf/internal/GaugeManager;->cpuGaugeCollector:Lcom/google/firebase/perf/gauges/c;

    .line 16
    iput-object p6, p0, Lcom/google/firebase/perf/internal/GaugeManager;->memoryGaugeCollector:Lcom/google/firebase/perf/gauges/f;

    return-void
.end method

.method private static collectGaugeMetricOnce(Lcom/google/firebase/perf/gauges/c;Lcom/google/firebase/perf/gauges/f;Lcom/google/firebase/perf/util/Timer;)V
    .locals 0

    .line 2
    invoke-virtual {p0, p2}, Lcom/google/firebase/perf/gauges/c;->a(Lcom/google/firebase/perf/util/Timer;)V

    .line 3
    invoke-virtual {p1, p2}, Lcom/google/firebase/perf/gauges/f;->a(Lcom/google/firebase/perf/util/Timer;)V
...
.method private getCpuGaugeCollectionFrequencyMs(Lcom/google/firebase/perf/v1/ApplicationProcessState;)J
    ...
    :cond_0
    iget-object p0, p0, Lcom/google/firebase/perf/internal/GaugeManager;->configResolver:Lcom/google/firebase/perf/config/a;
    ...
    :goto_0
    invoke-static {p0, p1}, Lcom/google/firebase/perf/gauges/c;->e(J)Z
...
.method private getGaugeMetadata()Lcom/google/firebase/perf/v1/e;
    ...
    invoke-static {}, Lcom/google/firebase/perf/v1/e;->R()Lcom/google/firebase/perf/v1/e$b;
    ...
    invoke-virtual {v0, v1}, Lcom/google/firebase/perf/v1/e$b;->G(Ljava/lang/String;)Lcom/google/firebase/perf/v1/e$b;
    ...
    invoke-virtual {v0, v1}, Lcom/google/firebase/perf/v1/e$b;->E(I)Lcom/google/firebase/perf/v1/e$b;

    move-result-object v0

    iget-object p0, p0, Lcom/google/firebase/perf/internal/GaugeManager;->gaugeMetadataManager:Lcom/google/firebase/perf/internal/i;

    invoke-virtual {p0}, Lcom/google/firebase/perf/internal/i;->d()I

    move-result p0

    invoke-virtual {v0, p0}, Lcom/google/firebase/perf/v1/e$b;->F(I)Lcom/google/firebase/perf/v1/e$b;
...
.method private getMemoryGaugeCollectionFrequencyMs(Lcom/google/firebase/perf/v1/ApplicationProcessState;)J
    ...
    :goto_0
    invoke-static {p0, p1}, Lcom/google/firebase/perf/gauges/f;->d(J)Z
...
.method private startCollectingCpuMetrics(JLcom/google/firebase/perf/util/Timer;)Z
    ...
    sget-object p0, Lcom/google/firebase/perf/internal/GaugeManager;->logger:Lcom/google/firebase/perf/logging/a;
    ...
    invoke-virtual {p0, p1, p3}, Lcom/google/firebase/perf/logging/a;->a(Ljava/lang/String;[Ljava/lang/Object;)V

    return p2

    :cond_0
    iget-object p0, p0, Lcom/google/firebase/perf/internal/GaugeManager;->cpuGaugeCollector:Lcom/google/firebase/perf/gauges/c;

    invoke-virtual {p0, p1, p2, p3}, Lcom/google/firebase/perf/gauges/c;->j(JLcom/google/firebase/perf/util/Timer;)V
...
.method private startCollectingMemoryMetrics(JLcom/google/firebase/perf/util/Timer;)Z
    ...
    :cond_0
    iget-object p0, p0, Lcom/google/firebase/perf/internal/GaugeManager;->memoryGaugeCollector:Lcom/google/firebase/perf/gauges/f;

    invoke-virtual {p0, p1, p2, p3}, Lcom/google/firebase/perf/gauges/f;->i(JLcom/google/firebase/perf/util/Timer;)V
...
.method private syncFlush(Ljava/lang/String;Lcom/google/firebase/perf/v1/ApplicationProcessState;)V
    ...
    invoke-static {}, Lcom/google/firebase/perf/v1/f;->Z()Lcom/google/firebase/perf/v1/f$b;

    move-result-object v0

    :goto_0
    iget-object v1, p0, Lcom/google/firebase/perf/internal/GaugeManager;->cpuGaugeCollector:Lcom/google/firebase/perf/gauges/c;

    iget-object v1, v1, Lcom/google/firebase/perf/gauges/c;->f:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    invoke-virtual {v0, v1}, Lcom/google/firebase/perf/v1/f$b;->E(Lcom/google/firebase/perf/v1/d;)Lcom/google/firebase/perf/v1/f$b;

    goto :goto_0

    :cond_0
    :goto_1
    iget-object v1, p0, Lcom/google/firebase/perf/internal/GaugeManager;->memoryGaugeCollector:Lcom/google/firebase/perf/gauges/f;

    iget-object v1, v1, Lcom/google/firebase/perf/gauges/f;->b:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    :cond_1
    invoke-virtual {v0, p1}, Lcom/google/firebase/perf/v1/f$b;->G(Ljava/lang/String;)Lcom/google/firebase/perf/v1/f$b;

    iget-object p0, p0, Lcom/google/firebase/perf/internal/GaugeManager;->transportManager:Lcom/google/firebase/perf/transport/l;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/google/firebase/perf/transport/l;->u(Lcom/google/firebase/perf/v1/f;Lcom/google/firebase/perf/v1/ApplicationProcessState;)V
...
.method public collectGaugeMetricOnce(Lcom/google/firebase/perf/util/Timer;)V
    ...
    .line 1
    iget-object v0, p0, Lcom/google/firebase/perf/internal/GaugeManager;->cpuGaugeCollector:Lcom/google/firebase/perf/gauges/c;

    iget-object p0, p0, Lcom/google/firebase/perf/internal/GaugeManager;->memoryGaugeCollector:Lcom/google/firebase/perf/gauges/f;

    invoke-static {v0, p0, p1}, Lcom/google/firebase/perf/internal/GaugeManager;->collectGaugeMetricOnce(Lcom/google/firebase/perf/gauges/c;Lcom/google/firebase/perf/gauges/f;Lcom/google/firebase/perf/util/Timer;)V
...
.method public logGaugeMetadata(Ljava/lang/String;Lcom/google/firebase/perf/v1/ApplicationProcessState;)Z
    ...
    invoke-virtual {p1, v0}, Lcom/google/firebase/perf/v1/f$b;->F(Lcom/google/firebase/perf/v1/e;)Lcom/google/firebase/perf/v1/f$b;
...
.method public startCollectingGauges(Lcom/google/firebase/perf/internal/PerfSession;Lcom/google/firebase/perf/v1/ApplicationProcessState;)V
    ...
    .line 7
    :try_start_0
    iget-object v4, p0, Lcom/google/firebase/perf/internal/GaugeManager;->gaugeManagerExecutor:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    .line 9
    sget-object p1, Lcom/google/firebase/perf/internal/GaugeManager;->logger:Lcom/google/firebase/perf/logging/a;
    ...
    invoke-virtual {p1, p0, p2}, Lcom/google/firebase/perf/logging/a;->f(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public stopCollectingGauges()V
    ...
    iget-object v2, p0, Lcom/google/firebase/perf/internal/GaugeManager;->cpuGaugeCollector:Lcom/google/firebase/perf/gauges/c;

    invoke-virtual {v2}, Lcom/google/firebase/perf/gauges/c;->k()V

    iget-object v2, p0, Lcom/google/firebase/perf/internal/GaugeManager;->memoryGaugeCollector:Lcom/google/firebase/perf/gauges/f;

    invoke-virtual {v2}, Lcom/google/firebase/perf/gauges/f;->j()V
