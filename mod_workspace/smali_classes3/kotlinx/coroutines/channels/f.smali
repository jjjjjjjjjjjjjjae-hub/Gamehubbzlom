...
# direct methods
.method public constructor <init>(JLkotlinx/coroutines/channels/f;Lkotlinx/coroutines/channels/BufferedChannel;I)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p5}, Lkotlinx/coroutines/internal/z;-><init>(JLkotlinx/coroutines/internal/z;I)V

    iput-object p4, p0, Lkotlinx/coroutines/channels/f;->e:Lkotlinx/coroutines/channels/BufferedChannel;
    ...
    iput-object p1, p0, Lkotlinx/coroutines/channels/f;->f:Ljava/util/concurrent/atomic/AtomicReferenceArray;
...
.method public final A(ILjava/lang/Object;)V
    ...
    iget-object p0, p0, Lkotlinx/coroutines/channels/f;->f:Ljava/util/concurrent/atomic/AtomicReferenceArray;
...
.method public final B(ILjava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lkotlinx/coroutines/channels/f;->z(ILjava/lang/Object;)V
...
.method public o(ILjava/lang/Throwable;Lkotlin/coroutines/CoroutineContext;)V
    ...
    :cond_1
    invoke-virtual {p0, p1}, Lkotlinx/coroutines/channels/f;->v(I)Ljava/lang/Object;

    move-result-object p2

    :cond_2
    :goto_1
    invoke-virtual {p0, p1}, Lkotlinx/coroutines/channels/f;->w(I)Ljava/lang/Object;
    ...
    :cond_9
    :goto_3
    invoke-virtual {p0, p1}, Lkotlinx/coroutines/channels/f;->s(I)V

    if-eqz v0, :cond_a

    invoke-virtual {p0}, Lkotlinx/coroutines/channels/f;->u()Lkotlinx/coroutines/channels/BufferedChannel;
    ...
    invoke-static {p0, p2, p3}, Lkotlinx/coroutines/internal/OnUndeliveredElementKt;->b(Lkotlin/jvm/functions/l;Ljava/lang/Object;Lkotlin/coroutines/CoroutineContext;)V
    ...
    :goto_5
    invoke-virtual {p0, p1, v1, v2}, Lkotlinx/coroutines/channels/f;->r(ILjava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1, v1}, Lkotlinx/coroutines/channels/f;->x(IZ)V
...
.method public final s(I)V
    ...
    invoke-virtual {p0, p1, v0}, Lkotlinx/coroutines/channels/f;->z(ILjava/lang/Object;)V
...
.method public final u()Lkotlinx/coroutines/channels/BufferedChannel;
    ...
    iget-object p0, p0, Lkotlinx/coroutines/channels/f;->e:Lkotlinx/coroutines/channels/BufferedChannel;
...
.method public final x(IZ)V
    ...
    invoke-virtual {p2, v0, v1}, Lkotlinx/coroutines/channels/BufferedChannel;->U0(J)V
