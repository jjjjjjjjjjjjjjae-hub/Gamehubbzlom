...
.method public final h(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p0}, Lkotlinx/coroutines/q0;->b()Lkotlin/coroutines/c;
...
.method public final run()V
    ...
    invoke-static {v2, v3, v1}, Lkotlinx/coroutines/CoroutineContextKt;->g(Lkotlin/coroutines/c;Lkotlin/coroutines/CoroutineContext;Ljava/lang/Object;)Lkotlinx/coroutines/q2;
    ...
    invoke-virtual {p0}, Lkotlinx/coroutines/q0;->j()Ljava/lang/Object;

    move-result-object v7

    invoke-virtual {p0, v7}, Lkotlinx/coroutines/q0;->d(Ljava/lang/Object;)Ljava/lang/Throwable;

    move-result-object v8

    if-nez v8, :cond_1

    iget v9, p0, Lkotlinx/coroutines/q0;->c:I
    ...
    sget-object v9, Lkotlinx/coroutines/o1;->S:Lkotlinx/coroutines/o1$b;

    invoke-interface {v6, v9}, Lkotlin/coroutines/CoroutineContext;->e(Lkotlin/coroutines/CoroutineContext$b;)Lkotlin/coroutines/CoroutineContext$a;

    move-result-object v6

    check-cast v6, Lkotlinx/coroutines/o1;
    ...
    invoke-interface {v6}, Lkotlinx/coroutines/o1;->f()Z

    move-result v9

    if-nez v9, :cond_2

    invoke-interface {v6}, Lkotlinx/coroutines/o1;->p()Ljava/util/concurrent/CancellationException;
    ...
    invoke-interface {v2, v6}, Lkotlin/coroutines/c;->k(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v7}, Lkotlinx/coroutines/q0;->g(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_2
    invoke-virtual {v4}, Lkotlinx/coroutines/q2;->b1()Z
    ...
    invoke-virtual {p0, v5, v0}, Lkotlinx/coroutines/q0;->h(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p0, v1, v0}, Lkotlinx/coroutines/q0;->h(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
