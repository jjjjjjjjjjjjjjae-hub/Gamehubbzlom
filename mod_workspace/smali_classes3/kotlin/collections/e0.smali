...
.method public static i(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1}, Lkotlin/collections/c0;->a(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static varargs j([Lkotlin/Pair;)Ljava/util/HashMap;
    .locals 2
    ...
    invoke-static {v0, p0}, Lkotlin/collections/e0;->q(Ljava/util/Map;[Lkotlin/Pair;)V
...
.method public static varargs k([Lkotlin/Pair;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lkotlin/collections/e0;->v([Lkotlin/Pair;Ljava/util/Map;)Ljava/util/Map;
...
.method public static final m(Ljava/util/Map;)Ljava/util/Map;
    ...
    :cond_0
    invoke-static {p0}, Lkotlin/collections/d0;->f(Ljava/util/Map;)Ljava/util/Map;
...
.method public static o(Ljava/util/Map;Lkotlin/Pair;)Ljava/util/Map;
    ...
    invoke-static {p1}, Lkotlin/collections/d0;->e(Lkotlin/Pair;)Ljava/util/Map;
...
.method public static r(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Lkotlin/collections/e0;->s(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lkotlin/collections/e0;->s(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;

    move-result-object p0

    invoke-static {p0}, Lkotlin/collections/e0;->m(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final s(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p1, p0}, Lkotlin/collections/e0;->p(Ljava/util/Map;Ljava/lang/Iterable;)V
...
.method public static u([Lkotlin/Pair;)Ljava/util/Map;
    .locals 2
...
.method public static final v([Lkotlin/Pair;Ljava/util/Map;)Ljava/util/Map;
    .locals 1
    ...
    invoke-static {p1, p0}, Lkotlin/collections/e0;->q(Ljava/util/Map;[Lkotlin/Pair;)V
