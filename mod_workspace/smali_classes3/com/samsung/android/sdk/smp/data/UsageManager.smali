...
.method private triggerUploadClientsWhenAppStarts(Landroid/content/Context;)V
    ...
    sget-object p0, Lcom/samsung/android/sdk/smp/data/UsageManager;->TAG:Ljava/lang/String;

    const-string v0, "upload clients when app starts"

    invoke-static {p0, v0}, Lcom/samsung/android/sdk/smp/common/util/SmpLog;->i(Ljava/lang/String;Ljava/lang/String;)V

    const/4 p0, 0x1

    invoke-static {p1, p0}, Lcom/samsung/android/sdk/smp/data/DataManager;->triggerUploadClientsNow(Landroid/content/Context;Z)V
...
.method public activityStarted(Landroid/app/Activity;)V
    ...
    iget-object p0, p0, Lcom/samsung/android/sdk/smp/data/UsageManager;->mSessionStartElapsedTime:Landroid/util/SparseArray;
