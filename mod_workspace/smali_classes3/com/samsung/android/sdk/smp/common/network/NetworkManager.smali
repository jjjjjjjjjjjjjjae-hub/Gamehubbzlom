...
.field private static requestQueue:Lcom/android/volley/i;
...
.method public static downloadResource(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)Lcom/samsung/android/sdk/smp/common/network/NetworkResult;
    ...
    invoke-static {}, Lcom/android/volley/toolbox/n;->b()Lcom/android/volley/toolbox/n;
    ...
    invoke-direct/range {v3 .. v8}, Lcom/samsung/android/sdk/smp/common/network/NetworkManager$CDNVolleyRequest;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/android/volley/j$b;Lcom/android/volley/j$a;)V
    ...
    invoke-virtual {v9, p1}, Lcom/android/volley/Request;->setRetryPolicy(Lcom/android/volley/l;)Lcom/android/volley/Request;

    invoke-static {p0}, Lcom/samsung/android/sdk/smp/common/network/NetworkManager;->getRequestQueue(Landroid/content/Context;)Lcom/android/volley/i;

    move-result-object p0

    invoke-virtual {p0, v9}, Lcom/android/volley/i;->a(Lcom/android/volley/Request;)Lcom/android/volley/Request;

    :try_start_0
    sget-object p0, Ljava/util/concurrent/TimeUnit;->SECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v2, p2, p3, p0}, Lcom/android/volley/toolbox/n;->get(JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
...
.method private static getRequestQueue(Landroid/content/Context;)Lcom/android/volley/i;
    .locals 1

    sget-object v0, Lcom/samsung/android/sdk/smp/common/network/NetworkManager;->requestQueue:Lcom/android/volley/i;
    ...
    invoke-static {p0}, Lcom/android/volley/toolbox/p;->a(Landroid/content/Context;)Lcom/android/volley/i;

    move-result-object p0

    sput-object p0, Lcom/samsung/android/sdk/smp/common/network/NetworkManager;->requestQueue:Lcom/android/volley/i;

    :cond_0
    sget-object p0, Lcom/samsung/android/sdk/smp/common/network/NetworkManager;->requestQueue:Lcom/android/volley/i;
...
.method private static getVolleyErrorMessage(Ljava/lang/Exception;)Ljava/lang/String;
    ...
    :cond_1
    iget-object p0, p0, Lcom/android/volley/VolleyError;->networkResponse:Lcom/android/volley/h;
    ...
    :cond_2
    iget-object v1, p0, Lcom/android/volley/h;->b:[B
    ...
    iget p0, p0, Lcom/android/volley/h;->a:I
...
.method public static request(Landroid/content/Context;Lcom/samsung/android/sdk/smp/common/network/NetworkRequest;I)Lcom/samsung/android/sdk/smp/common/network/NetworkResult;
    ...
    invoke-direct/range {v3 .. v8}, Lcom/samsung/android/sdk/smp/common/network/NetworkManager$GzipJsonUtf8VolleyRequest;-><init>(ILjava/lang/String;[BLcom/android/volley/j$b;Lcom/android/volley/j$a;)V
    ...
    invoke-direct/range {v3 .. v8}, Lcom/samsung/android/sdk/smp/common/network/NetworkManager$JsonUtf8VolleyRequest;-><init>(ILjava/lang/String;Ljava/lang/String;Lcom/android/volley/j$b;Lcom/android/volley/j$a;)V
    ...
    invoke-direct/range {v3 .. v8}, Lcom/samsung/android/sdk/smp/common/network/NetworkManager$StringUtf8VolleyRequest;-><init>(ILjava/lang/String;Ljava/lang/String;Lcom/android/volley/j$b;Lcom/android/volley/j$a;)V
    ...
    invoke-virtual {v10, p1}, Lcom/android/volley/Request;->setRetryPolicy(Lcom/android/volley/l;)Lcom/android/volley/Request;

    invoke-static {p0}, Lcom/samsung/android/sdk/smp/common/network/NetworkManager;->getRequestQueue(Landroid/content/Context;)Lcom/android/volley/i;

    move-result-object p0

    invoke-virtual {p0, v10}, Lcom/android/volley/i;->a(Lcom/android/volley/Request;)Lcom/android/volley/Request;

    sget-object p0, Ljava/util/concurrent/TimeUnit;->SECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v2, v3, v4, p0}, Lcom/android/volley/toolbox/n;->get(JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
