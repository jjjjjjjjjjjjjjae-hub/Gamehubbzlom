...
.method private createDefaultNotificationChannel(Landroid/content/Context;ILjava/lang/String;IZ)V
    ...
    invoke-virtual {v0, p4, p4}, Landroid/app/NotificationChannel;->setSound(Landroid/net/Uri;Landroid/media/AudioAttributes;)V
    ...
    invoke-virtual {p0, p2, p3}, Lcom/samsung/android/sdk/smp/common/preference/PrefManager;->setNotiChannelId(ILjava/lang/String;)V

    return-void

    :cond_0
    sget-object p0, Lcom/samsung/android/sdk/smp/display/DisplayManager;->TAG:Ljava/lang/String;
...
.method public getNotificationChannelId(Landroid/content/Context;I)Ljava/lang/String;
    ...
    const-string p1, "cannot show noti : channel is not created"
    ...
    const-string p1, "cannot show noti : notification manager null"
