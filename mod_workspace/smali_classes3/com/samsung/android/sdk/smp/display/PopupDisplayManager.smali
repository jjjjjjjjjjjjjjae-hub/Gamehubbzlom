...
.method private delayDisplayNotToDisturb(Landroid/content/Context;Lcom/samsung/android/sdk/smp/display/DisplayResultHandler;)V
    ...
    invoke-virtual {p0, v0}, Lcom/samsung/android/sdk/smp/common/database/DBHandler;->getMarketingFailCount(Ljava/lang/String;)I
    ...
    invoke-virtual {p0, v1, v2}, Lcom/samsung/android/sdk/smp/common/database/DBHandler;->updateMarketingFailCount(Ljava/lang/String;I)Z
    ...
    sget-object p0, Lcom/samsung/android/sdk/smp/display/PopupDisplayManager;->TAG:Ljava/lang/String;

    invoke-virtual {p2}, Lcom/samsung/android/sdk/smp/display/DisplayResultHandler;->getMid()Ljava/lang/String;

    move-result-object v0

    const-string v1, "fail to display. currently busy"

    invoke-static {p0, v0, v1}, Lcom/samsung/android/sdk/smp/common/util/SmpLog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p2, p1, p0, v0}, Lcom/samsung/android/sdk/smp/display/DisplayResultHandler;->onFail(Landroid/content/Context;Lcom/samsung/android/sdk/smp/common/constants/FeedbackEvent;Ljava/lang/String;)V
...
.method public clear(Landroid/content/Context;I)Z
    ...
    const-class v2, Lcom/samsung/android/sdk/smp/SmpPopupService;
    ...
    sget-object p1, Lcom/samsung/android/sdk/smp/display/PopupDisplayManager;->TAG:Ljava/lang/String;
...
.method public display(Landroid/content/Context;Landroid/os/Bundle;Lcom/samsung/android/sdk/smp/display/DisplayResultHandler;)V
    ...
    const-string v3, "not supported type. type:"
    ...
    invoke-static {p0, v1, p2}, Lcom/samsung/android/sdk/smp/common/util/SmpLog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string p2, "extra_channel_id"
    ...
    const-class p2, Lcom/samsung/android/sdk/smp/SmpPopupService;
    ...
    invoke-static {p2, v1, p0}, Lcom/samsung/android/sdk/smp/common/util/SmpLog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
