...
.method private getBannerOrFoldedViewFlipperLayoutId(Landroid/content/Context;)I
    ...
    sget p0, Lcom/samsung/android/sdk/smp/R$layout;->noti_banner_or_folded_viewflipper_for_tablet:I

    return p0

    :cond_0
    sget p0, Lcom/samsung/android/sdk/smp/R$layout;->noti_banner_or_folded_viewflipper:I
    ...
    const-string v1, "fail to get banner or viewflipper layout id. invalid contents type : "
...
.method private getBannerRemoteView(Landroid/content/Context;Landroid/os/Bundle;)Landroid/widget/RemoteViews;
    ...
    sget p0, Lcom/samsung/android/sdk/smp/R$id;->banner_icon:I
    ...
    :cond_0
    sget-object p0, Lcom/samsung/android/sdk/smp/display/NotificationDisplayManager;->TAG:Ljava/lang/String;

    const-string p1, "fail to make notification. banner path null"
...
.method private getClickPendingIntent(Landroid/content/Context;Ljava/lang/String;IZLjava/util/ArrayList;)Landroid/app/PendingIntent;
    ...
    sput-boolean p2, Lcom/samsung/android/sdk/smp/display/NotificationDisplayManager;->mIsClickIntentLaunchable:Z
...
.method private getDeletePendingIntent(Landroid/content/Context;Ljava/lang/String;I)Landroid/app/PendingIntent;
    ...
    invoke-static {p1, p2, p0, p3}, Lcom/samsung/android/sdk/smp/display/DisplayManager;->getDeleteIntent(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;I)Landroid/content/Intent;
...
.method private getExpandedViewFlipperLayoutId(Landroid/content/Context;)I
    ...
    sget p0, Lcom/samsung/android/sdk/smp/R$layout;->expanded_viewflipper:I
    ...
    const-string v1, "fail to get expanded viewflipper layout id. invalid contents type : "
...
.method private getNotification(Landroid/content/Context;Landroid/os/Bundle;I)Landroid/app/Notification;
    ...
    const-string p1, "fail to get notification. invalid data"
    ...
    const-string p3, "fail to get notification. IllegalStateException. "
    ...
    const-string p1, "fail to get notification. not supported type"
...
.method private getNotificationBuilder(Landroid/content/Context;Landroid/os/Bundle;)Landroid/app/Notification$Builder;
    ...
    invoke-direct {p2, p1, p0}, Landroid/app/Notification$Builder;-><init>(Landroid/content/Context;Ljava/lang/String;)V
...
.method private getNotificationButtonClickPendingIntent(Ljava/lang/String;ILjava/util/ArrayList;ILandroid/content/Context;Z)Landroid/app/PendingIntent;
    ...
    invoke-static {p5, p4, p0, p1}, Landroid/app/PendingIntent;->getBroadcast(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
...
.method private getViewFlipperRemoteView(Landroid/content/Context;Landroid/os/Bundle;Z)Landroid/widget/RemoteViews;
    ...
    const-string p1, "fail to make notification. invalid flipper period, images"
    ...
    const-string p1, "fail to make notification. flipper paths null"
...
.method private getViewFlipperResId(I)I
    ...
    sget p0, Lcom/samsung/android/sdk/smp/R$id;->viewflipper:I

    return p0

    :cond_0
    sget p0, Lcom/samsung/android/sdk/smp/R$id;->viewflipper_anim3:I

    return p0

    :cond_1
    sget p0, Lcom/samsung/android/sdk/smp/R$id;->viewflipper_anim2:I

    return p0

    :cond_2
    sget p0, Lcom/samsung/android/sdk/smp/R$id;->viewflipper_anim1:I
...
.method private setBasicBuilder(Landroid/content/Context;Landroid/app/Notification$Builder;Landroid/os/Bundle;)V
    ...
    const-string p1, "fail to build basic notification. invalid params"
...
.method private setBigPictureBuilder(Landroid/content/Context;Landroid/app/Notification$Builder;Landroid/os/Bundle;)V
    ...
    const-string p0, "content_text"

    invoke-virtual {p3, p0}, Landroid/os/BaseBundle;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p0

    const-string p1, "big_picture"
    ...
    invoke-static {p1}, Lcom/samsung/android/sdk/smp/display/DisplayManager;->decodeFile(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    const-string p0, "sub_content_text"
    ...
    invoke-virtual {p2, p0}, Landroid/app/Notification$Builder;->setContentText(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;
    ...
    const-string p1, "fail to build bigpicture notification. invalid map"
...
.method private setBigTextBuilder(Landroid/content/Context;Landroid/app/Notification$Builder;Landroid/os/Bundle;)V
    ...
    const-string p1, "fail to build bigtext notification. invalid map"
...
.method private setNotificationConfigs(Landroid/content/Context;Landroid/os/Bundle;Landroid/app/Notification;)V
    ...
    iput p0, p3, Landroid/app/Notification;->color:I
    ...
    iput p2, p3, Landroid/app/Notification;->priority:I
    ...
    iget p0, p3, Landroid/app/Notification;->defaults:I
    ...
    iput-object p0, p3, Landroid/app/Notification;->sound:Landroid/net/Uri;
...
.method public clear(Landroid/content/Context;I)Z
    ...
    const-string v1, "clear notification in the noti bar. displayId : "
...
.method public display(Landroid/content/Context;Landroid/os/Bundle;Lcom/samsung/android/sdk/smp/display/DisplayResultHandler;)V
    ...
    invoke-static {p0, p2}, Lcom/samsung/android/sdk/smp/common/util/SmpLog;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p3, p1, p0, v0}, Lcom/samsung/android/sdk/smp/display/DisplayResultHandler;->onFail(Landroid/content/Context;Lcom/samsung/android/sdk/smp/common/constants/FeedbackEvent;Ljava/lang/String;)V
    ...
    sget-boolean p0, Lcom/samsung/android/sdk/smp/display/NotificationDisplayManager;->mIsClickIntentLaunchable:Z
    ...
    :cond_2
    const-string p0, "landing_page_may_not_launchable"

    :goto_0
    const/4 v1, 0x1

    invoke-virtual {p3, p1, p0, v1}, Lcom/samsung/android/sdk/smp/display/DisplayResultHandler;->onSuccess(Landroid/content/Context;Ljava/lang/String;Z)V
    ...
    .catch Lcom/samsung/android/sdk/smp/common/exception/InternalException$AppIconNotfoundException; {:try_start_0 .. :try_end_0} :catch_4
    .catch Lcom/samsung/android/sdk/smp/common/exception/InternalException$NotSupportedTypeException; {:try_start_0 .. :try_end_0} :catch_3
    ...
    invoke-virtual {p3, p1, p2, p0}, Lcom/samsung/android/sdk/smp/display/DisplayResultHandler;->onFail(Landroid/content/Context;Lcom/samsung/android/sdk/smp/common/constants/FeedbackEvent;Ljava/lang/String;)V
    ...
    invoke-virtual {p3, p1, p0, p2}, Lcom/samsung/android/sdk/smp/display/DisplayResultHandler;->onFail(Landroid/content/Context;Lcom/samsung/android/sdk/smp/common/constants/FeedbackEvent;Ljava/lang/String;)V
