...
.method public constructor <init>(Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator$RunType;)V
    ...
    :cond_0
    sget-object p0, Lcom/samsung/android/sdk/smp/marketing/LandingIntentGenerator;->TAG:Ljava/lang/String;
...
.method private getLandingIntentForApp(Landroid/content/Context;Ljava/lang/String;Lcom/samsung/android/sdk/smp/marketing/MarketingLink;ZZ)Landroid/content/Intent;
    ...
    const-string p1, "fail to get landing intent(type:app). pkg null"

    invoke-static {p0, p2, p1}, Lcom/samsung/android/sdk/smp/common/util/SmpLog;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string p4, "fail to get landing intent(type:app) : "
    ...
    const-string p1, "landing intent : app"
...
.method private getLandingIntentForIntent(Landroid/content/Context;Ljava/lang/String;Lcom/samsung/android/sdk/smp/marketing/MarketingLink;ZZZ)Landroid/content/Intent;
    ...
    const-string p1, "fail to get landing intent(type:intent). pkg null"
    ...
    const-string p1, "fail to get landing intent(type:intent). invalid component"
    ...
    const-string p4, "fail to get landing intent(type:intent). "
...
.method private getLandingIntentForUrl(Landroid/content/Context;Ljava/lang/String;Lcom/samsung/android/sdk/smp/marketing/MarketingLink;ZZZ)Landroid/content/Intent;
    ...
    const-string p1, "fail to get landing intent(type:url). url null"
    ...
    const-string p1, "fail to get landing intent(type:url). it is not able to launch"
    ...
    const-string p1, "landing intent : url (original)"
    ...
    const-string p3, "landing intent : url (redirect)"
    ...
    invoke-static {p0, p2, p1}, Lcom/samsung/android/sdk/smp/common/util/SmpLog;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method private getSmpPK(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/samsung/android/sdk/smp/common/util/SecurityUtil;->makeSHA256Hash(Ljava/lang/String;)Ljava/lang/String;
...
.method private putSmpPKToExtra(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Z)V
    ...
    const-string p2, "put smpPK to extra"
...
.method public appendReferrerToUrl(Ljava/lang/String;Lcom/samsung/android/sdk/smp/marketing/MarketingLink;)Landroid/net/Uri;
    ...
    const-string v0, "append referrer to url"
...
.method public getLandingIntentByLinkType(Landroid/content/Context;Ljava/lang/String;Lcom/samsung/android/sdk/smp/marketing/MarketingLink;ZZZ)Landroid/content/Intent;
    ...
    const-string p1, "fail to get landing intent. link is null"
    ...
    const-string p4, "fail to get landing intent. invalid type : "
...
.method public getLandingIntentForOriginalUrl(Landroid/content/Context;Ljava/lang/String;Lcom/samsung/android/sdk/smp/marketing/MarketingLink;ZZZ)Landroid/content/Intent;
    ...
    const-string p3, "fail to get landing intent(type:url). "
...
.method public getLandingIntentFromSmpProvider(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)Landroid/content/Intent;
    ...
    invoke-static {p1, p0}, Lcom/samsung/android/sdk/smp/settingshelper/SystemAppProviderConnector;->getUriData(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
