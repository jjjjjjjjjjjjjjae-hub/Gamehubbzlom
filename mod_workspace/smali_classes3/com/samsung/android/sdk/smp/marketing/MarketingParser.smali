...
.method private isValidTime(Ljava/lang/String;Lcom/samsung/android/sdk/smp/marketing/MarketingParser$MarketingDisplayTime;IIJI[I)Z
    ...
    iget-object v6, v2, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$MarketingDisplayTime;->timeBase:Ljava/lang/String;
    ...
    const-string v1, "invalid timeBase"
    ...
    const-string v2, "invalid displayTime"

    invoke-static {v0, p1, v2}, Lcom/samsung/android/sdk/smp/common/util/SmpLog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v2, "invalid doNotDisturbTime"
...
.method private isValidTimeRange(Ljava/lang/String;Lcom/samsung/android/sdk/smp/common/util/TimeUtil$Time;Lcom/samsung/android/sdk/smp/common/util/TimeUtil$Time;Z)Z
    ...
    const-string p2, "invalid time range : start and end time are same"
    ...
    const-string p2, "invalid time range : min"
    ...
    const-string p2, "invalid time range : hour"
...
.method public static parseMarketingDisplayTime(Ljava/lang/String;Lorg/json/JSONObject;)Lcom/samsung/android/sdk/smp/marketing/MarketingParser$MarketingDisplayTime;
    ...
    invoke-static {p0, p1, v0, v2}, Lcom/samsung/android/sdk/smp/marketing/MarketingParser;->parseTimeList(Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/Class;)Ljava/util/List;
    ...
    invoke-static {p0, p1, v5, v2, v4}, Lcom/samsung/android/sdk/smp/marketing/MarketingParser;->parseTimeList(Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/Class;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {p0, p1, v6, v7}, Lcom/samsung/android/sdk/smp/marketing/MarketingParser;->parseTimeList(Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/Class;)Ljava/util/List;
    ...
    sget-object v7, Lcom/samsung/android/sdk/smp/common/constants/MarketingConstants;->DEFAULT_DO_NOT_DISTURB_TIME:Ljava/util/List;

    invoke-static {p0, p1, v1, v2, v7}, Lcom/samsung/android/sdk/smp/marketing/MarketingParser;->parseTimeList(Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/Class;Ljava/util/List;)Ljava/util/List;

    move-result-object v1

    const-string v7, "doNotDisturbTimeMin"

    invoke-static {p0, p1, v7, v2, v4}, Lcom/samsung/android/sdk/smp/marketing/MarketingParser;->parseTimeList(Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/Class;Ljava/util/List;)Ljava/util/List;
    ...
    :goto_0
    new-instance v8, Lcom/samsung/android/sdk/smp/common/util/TimeUtil$Time;
    ...
    invoke-direct {v8, v1, v2}, Lcom/samsung/android/sdk/smp/common/util/TimeUtil$Time;-><init>(II)V
    ...
    invoke-direct {v9, v0, v2}, Lcom/samsung/android/sdk/smp/common/util/TimeUtil$Time;-><init>(II)V
    ...
    invoke-direct {v10, v0, v2}, Lcom/samsung/android/sdk/smp/common/util/TimeUtil$Time;-><init>(II)V
    ...
    invoke-direct {v11, p0, v0}, Lcom/samsung/android/sdk/smp/common/util/TimeUtil$Time;-><init>(II)V
...
.method public parseUserData(Landroid/content/Context;Lcom/samsung/android/sdk/smp/marketing/Marketing;Lorg/json/JSONObject;)V
    ...
    invoke-virtual {v10, v1}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setStyle(Lorg/json/JSONObject;)V

    invoke-virtual/range {p2 .. p2}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->getMid()Ljava/lang/String;

    move-result-object v1

    invoke-static {v1, v11}, Lcom/samsung/android/sdk/smp/marketing/MarketingParser;->parseMarketingDisplayTime(Ljava/lang/String;Lorg/json/JSONObject;)Lcom/samsung/android/sdk/smp/marketing/MarketingParser$MarketingDisplayTime;
    ...
    invoke-virtual {v11, v1, v8}, Lorg/json/JSONObject;->optInt(Ljava/lang/String;I)I
    ...
    invoke-direct {v0, v1}, Lcom/samsung/android/sdk/smp/marketing/MarketingParser;->parseFeedbackDispersion(Lorg/json/JSONArray;)[I
    ...
    invoke-virtual {v10, v1}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setFeedbackDispersionMin(I)V

    const/4 v1, 0x1

    aget v2, v16, v1

    invoke-virtual {v10, v2}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setFeedbackDispersionMax(I)V
    ...
    invoke-virtual {v10, v2}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setTimeBase(Ljava/lang/String;)V
    ...
    invoke-virtual {v10, v2}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setDisplayTimeStart(Lcom/samsung/android/sdk/smp/common/util/TimeUtil$Time;)V
    ...
    invoke-virtual {v10, v2}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setDisplayTimeEnd(Lcom/samsung/android/sdk/smp/common/util/TimeUtil$Time;)V
    ...
    invoke-virtual {v10, v2}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setDoNotDisturbTimeStart(Lcom/samsung/android/sdk/smp/common/util/TimeUtil$Time;)V
    ...
    invoke-virtual {v10, v2}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setDoNotDisturbTimeEnd(Lcom/samsung/android/sdk/smp/common/util/TimeUtil$Time;)V

    iget-wide v2, v13, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$MarketingDisplayTime;->ttlStartMillis:J

    invoke-virtual {v10, v2, v3}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setTtlStartMillis(J)V

    iget-wide v2, v13, Lcom/samsung/android/sdk/smp/marketing/MarketingParser$MarketingDisplayTime;->ttlEndMillis:J

    invoke-virtual {v10, v2, v3}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setTtlEndMillis(J)V

    invoke-virtual {v10, v14, v15}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setClearTimeMillis(J)V

    move/from16 v2, v19

    invoke-virtual {v10, v2}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setRandomMinutes(I)V

    invoke-virtual {v10, v0}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setCctimeMinutes(I)V

    const-string v0, "pLink"

    invoke-virtual {v11, v0, v12}, Lorg/json/JSONObject;->optBoolean(Ljava/lang/String;Z)Z

    move-result v0

    invoke-virtual {v10, v0}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setPLink(Z)V
    ...
    invoke-virtual {v10, v0}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setScreenOnTimeMinutes(I)V
    ...
    invoke-virtual {v10, v0}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setContentsUrl(Lorg/json/JSONObject;)V
    ...
    :cond_2
    invoke-virtual {v10, v0}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setChannelType(I)V
    ...
    new-instance v3, Lcom/samsung/android/sdk/smp/marketing/MarketingFilter;

    invoke-direct {v3}, Lcom/samsung/android/sdk/smp/marketing/MarketingFilter;-><init>()V
    ...
    invoke-virtual {v3, v7}, Lcom/samsung/android/sdk/smp/marketing/MarketingFilter;->setInstallPkg(Lorg/json/JSONArray;)V

    invoke-virtual {v4, v5}, Lorg/json/JSONObject;->getInt(Ljava/lang/String;)I

    move-result v4

    invoke-virtual {v3, v4}, Lcom/samsung/android/sdk/smp/marketing/MarketingFilter;->setInstallCount(I)V

    :cond_3
    const-string v4, "notInstall"
    ...
    invoke-virtual {v3, v4}, Lcom/samsung/android/sdk/smp/marketing/MarketingFilter;->setNotInstallPkg(Lorg/json/JSONArray;)V

    invoke-virtual {v0, v5}, Lorg/json/JSONObject;->getInt(Ljava/lang/String;)I

    move-result v0

    invoke-virtual {v3, v0}, Lcom/samsung/android/sdk/smp/marketing/MarketingFilter;->setNotInstallCount(I)V

    :cond_4
    move-object/from16 v0, p0

    invoke-direct {v0, v3}, Lcom/samsung/android/sdk/smp/marketing/MarketingParser;->isValidFilter(Lcom/samsung/android/sdk/smp/marketing/MarketingFilter;)Z

    move-result v0

    if-eqz v0, :cond_5

    invoke-virtual {v10, v3}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setFilter(Lcom/samsung/android/sdk/smp/marketing/MarketingFilter;)V
    ...
    invoke-virtual {v10, v0, v0, v0, v0}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setFreqCapping(IIII)V
    ...
    invoke-virtual {v10, v3, v1, v2, v0}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setFreqCapping(IIII)V
    ...
    invoke-virtual {v10, v0}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setUndeletable(Z)V
