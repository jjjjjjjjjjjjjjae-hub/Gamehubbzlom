.class public Lcom/samsung/android/game/gamehome/data/db/cache/dao/h0$c;
...
.method public constructor <init>(Lcom/samsung/android/game/gamehome/data/db/cache/dao/h0;Landroidx/room/RoomDatabase;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/game/gamehome/data/db/cache/dao/h0$c;->d:Lcom/samsung/android/game/gamehome/data/db/cache/dao/h0;
...
.method public e()Ljava/lang/String;
    ...
    const-string p0, "UPDATE OR ABORT `YoutubeMore` SET `resultCode` = ?,`packageName` = ?,`requestKey` = ?,`nextKey` = ?,`requestKeyExpiredTopRanked` = ?,`totalNumber` = ?,`videoList` = ?,`timeStamp` = ?,`locale` = ? WHERE `packageName` = ? AND `requestKey` = ?"
...
.method public bridge synthetic i(Landroidx/sqlite/db/k;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/samsung/android/game/gamehome/data/db/cache/dao/h0$c;->l(Landroidx/sqlite/db/k;Lcom/samsung/android/game/gamehome/network/gamelauncher/model/game/YoutubeMoreResponse;)V

    return-void
.end method

.method public l(Landroidx/sqlite/db/k;Lcom/samsung/android/game/gamehome/network/gamelauncher/model/game/YoutubeMoreResponse;)V
    .locals 4
    ...
    iget-object p0, p0, Lcom/samsung/android/game/gamehome/data/db/cache/dao/h0$c;->d:Lcom/samsung/android/game/gamehome/data/db/cache/dao/h0;
