.class public Lcom/samsung/android/game/gamehome/data/db/cache/dao/f$c;
...
.method public constructor <init>(Lcom/samsung/android/game/gamehome/data/db/cache/dao/f;Landroidx/room/RoomDatabase;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/game/gamehome/data/db/cache/dao/f$c;->d:Lcom/samsung/android/game/gamehome/data/db/cache/dao/f;
...
.method public e()Ljava/lang/String;
    ...
    const-string p0, "UPDATE OR ABORT `CuratedResult` SET `testId` = ?,`segmentId` = ?,`cloudYn` = ?,`slotList` = ?,`categoryList` = ?,`videoList` = ?,`primaryKey` = ?,`rcuId` = ?,`timeStamp` = ?,`locale` = ? WHERE `primaryKey` = ? AND `rcuId` = ?"
...
.method public bridge synthetic i(Landroidx/sqlite/db/k;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/samsung/android/game/gamehome/data/db/cache/dao/f$c;->l(Landroidx/sqlite/db/k;Lcom/samsung/android/game/gamehome/network/gamelauncher/model/main/response/CuratedResult;)V

    return-void
.end method

.method public l(Landroidx/sqlite/db/k;Lcom/samsung/android/game/gamehome/network/gamelauncher/model/main/response/CuratedResult;)V
    .locals 2
    ...
    :goto_2
    iget-object v0, p0, Lcom/samsung/android/game/gamehome/data/db/cache/dao/f$c;->d:Lcom/samsung/android/game/gamehome/data/db/cache/dao/f;
    ...
    :goto_4
    iget-object p0, p0, Lcom/samsung/android/game/gamehome/data/db/cache/dao/f$c;->d:Lcom/samsung/android/game/gamehome/data/db/cache/dao/f;
