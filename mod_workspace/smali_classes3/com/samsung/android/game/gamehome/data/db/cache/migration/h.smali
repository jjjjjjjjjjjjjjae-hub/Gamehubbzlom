.class public final Lcom/samsung/android/game/gamehome/data/db/cache/migration/h;
...
.method public a(Landroidx/sqlite/db/g;)V
    ...
    const-string v1, "FrvrFeaturedResponse"

    invoke-virtual {v0, p1, v1}, Lcom/samsung/android/game/gamehome/data/utility/c;->c(Landroidx/sqlite/db/g;Ljava/lang/String;)V

    invoke-virtual {p0, p1}, Lcom/samsung/android/game/gamehome/data/db/cache/migration/h;->f(Landroidx/sqlite/db/g;)V

    invoke-virtual {p0, p1}, Lcom/samsung/android/game/gamehome/data/db/cache/migration/h;->g(Landroidx/sqlite/db/g;)V

    invoke-virtual {p0, p1}, Lcom/samsung/android/game/gamehome/data/db/cache/migration/h;->e(Landroidx/sqlite/db/g;)V

    invoke-virtual {p0, p1}, Lcom/samsung/android/game/gamehome/data/db/cache/migration/h;->b(Landroidx/sqlite/db/g;)V

    invoke-virtual {p0, p1}, Lcom/samsung/android/game/gamehome/data/db/cache/migration/h;->c(Landroidx/sqlite/db/g;)V

    invoke-virtual {p0, p1}, Lcom/samsung/android/game/gamehome/data/db/cache/migration/h;->d(Landroidx/sqlite/db/g;)V
...
.method public final b(Landroidx/sqlite/db/g;)V
    ...
    const-string p0, "RecentInstantSearchKeyword"
...
.method public final d(Landroidx/sqlite/db/g;)V
    ...
    invoke-virtual {v1, v2, v8}, Lcom/samsung/android/game/gamehome/data/utility/d;->g(Ljava/lang/String;Z)Lcom/samsung/android/game/gamehome/data/utility/d;
...
.method public final e(Landroidx/sqlite/db/g;)V
    ...
    const-string v3, "gameGroup"

    const/4 v5, 0x2

    invoke-static {v2, v3, v4, v5, v6}, Lcom/samsung/android/game/gamehome/data/utility/d;->h(Lcom/samsung/android/game/gamehome/data/utility/d;Ljava/lang/String;ZILjava/lang/Object;)Lcom/samsung/android/game/gamehome/data/utility/d;

    move-result-object v2

    const-string v3, "instantGameGroup"
    ...
    const-string v15, "instantGamePageIndex"
    ...
    const-string v3, "instantCompanyPageIndex"
    ...
    const-string v10, "gamePageIndex"
...
.method public final g(Landroidx/sqlite/db/g;)V
    ...
    const-string p0, "SuggestionKeyword"
