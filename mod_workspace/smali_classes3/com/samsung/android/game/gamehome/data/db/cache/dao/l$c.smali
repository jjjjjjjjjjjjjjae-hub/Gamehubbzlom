.class public Lcom/samsung/android/game/gamehome/data/db/cache/dao/l$c;
...
.method public constructor <init>(Lcom/samsung/android/game/gamehome/data/db/cache/dao/l;Landroidx/room/RoomDatabase;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/game/gamehome/data/db/cache/dao/l$c;->d:Lcom/samsung/android/game/gamehome/data/db/cache/dao/l;
...
.method public e()Ljava/lang/String;
    ...
    const-string p0, "UPDATE OR ABORT `GameDetail` SET `gameGenre` = ?,`packageName` = ?,`strategyPackageName` = ?,`link` = ?,`statsInfo2` = ?,`title` = ?,`contentId` = ?,`orientation` = ?,`companyName` = ?,`sellerPrivatePolicy` = ?,`gameType` = ?,`iapSupport` = ?,`isFree` = ?,`restrictedAge` = ?,`gameGradeDescription` = ?,`gameGradeImageUrl` = ?,`storeId` = ?,`iconUrl` = ?,`description` = ?,`screenShotImageUrls` = ?,`youtubeId` = ?,`youtubeScreenShotUrl` = ?,`rankInfos` = ?,`linkType` = ?,`isEmptyObject` = ?,`timeStamp` = ?,`locale` = ? WHERE `packageName` = ?"
...
.method public bridge synthetic i(Landroidx/sqlite/db/k;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/samsung/android/game/gamehome/data/db/cache/dao/l$c;->l(Landroidx/sqlite/db/k;Lcom/samsung/android/game/gamehome/network/gamelauncher/model/detail2/GameDetail;)V
...
.method public l(Landroidx/sqlite/db/k;Lcom/samsung/android/game/gamehome/network/gamelauncher/model/detail2/GameDetail;)V
    ...
    :goto_3
    iget-object v0, p0, Lcom/samsung/android/game/gamehome/data/db/cache/dao/l$c;->d:Lcom/samsung/android/game/gamehome/data/db/cache/dao/l;
    ...
    :goto_10
    iget-object p0, p0, Lcom/samsung/android/game/gamehome/data/db/cache/dao/l$c;->d:Lcom/samsung/android/game/gamehome/data/db/cache/dao/l;
