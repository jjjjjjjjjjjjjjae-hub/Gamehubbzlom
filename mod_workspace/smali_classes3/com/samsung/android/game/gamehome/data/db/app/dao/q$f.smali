.class public Lcom/samsung/android/game/gamehome/data/db/app/dao/q$f;
...
.method public constructor <init>(Lcom/samsung/android/game/gamehome/data/db/app/dao/q;Landroidx/room/RoomDatabase;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/game/gamehome/data/db/app/dao/q$f;->d:Lcom/samsung/android/game/gamehome/data/db/app/dao/q;
...
.method public e()Ljava/lang/String;
    ...
    const-string p0, "UPDATE OR ABORT `PlayTimeItem` SET `guid` = ?,`deviceId` = ?,`packageName` = ?,`key` = ?,`totalPlayTime` = ?,`lastPlayTime` = ?,`installTime` = ?,`uploadTime` = ?,`dailyPlayTimeList` = ?,`gameName` = ?,`genre` = ?,`installed` = ?,`iconUrl` = ?,`isGame` = ? WHERE `key` = ?"
...
.method public bridge synthetic i(Landroidx/sqlite/db/k;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/samsung/android/game/gamehome/data/db/app/dao/q$f;->l(Landroidx/sqlite/db/k;Lcom/samsung/android/game/gamehome/data/db/app/entity/j;)V
...
.method public l(Landroidx/sqlite/db/k;Lcom/samsung/android/game/gamehome/data/db/app/entity/j;)V
    ...
    iget-object p0, p0, Lcom/samsung/android/game/gamehome/data/db/app/dao/q$f;->d:Lcom/samsung/android/game/gamehome/data/db/app/dao/q;
