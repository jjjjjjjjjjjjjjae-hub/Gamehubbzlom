.class public Lcom/samsung/android/game/gamehome/data/db/app/dao/g$m;
...
.method public constructor <init>(Lcom/samsung/android/game/gamehome/data/db/app/dao/g;Landroidx/room/RoomDatabase;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/game/gamehome/data/db/app/dao/g$m;->d:Lcom/samsung/android/game/gamehome/data/db/app/dao/g;
...
.method public e()Ljava/lang/String;
    ...
    const-string p0, "UPDATE OR ABORT `GameItem` SET `packageName` = ?,`itemType` = ?,`orderId` = ?,`gameName` = ?,`installationSource` = ?,`genre` = ?,`gameId` = ?,`installTime` = ?,`addedTime` = ?,`lastPlayTime` = ?,`totalPlayTime` = ?,`pinned` = ?,`removed` = ?,`gameIconUrl` = ?,`cid` = ?,`lastUsageEventType` = ?,`link` = ? WHERE `packageName` = ?"
...
.method public bridge synthetic i(Landroidx/sqlite/db/k;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/samsung/android/game/gamehome/data/db/app/dao/g$m;->l(Landroidx/sqlite/db/k;Lcom/samsung/android/game/gamehome/data/db/app/entity/d;)V
