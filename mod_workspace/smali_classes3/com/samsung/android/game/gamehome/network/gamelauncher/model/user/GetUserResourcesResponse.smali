.class public final Lcom/samsung/android/game/gamehome/network/gamelauncher/model/user/GetUserResourcesResponse;
...
.field private final userResourceList:Ljava/util/List;
    .annotation runtime Lcom/squareup/moshi/e;
        name = "resources"
    .end annotation
...
.method public constructor <init>(Ljava/lang/String;Ljava/util/List;)V
    ...
    const-string v0, "userResourceList"
    ...
    .line 2
    iput-object p1, p0, Lcom/samsung/android/game/gamehome/network/gamelauncher/model/user/GetUserResourcesResponse;->resultCode:Ljava/lang/String;

    .line 3
    iput-object p2, p0, Lcom/samsung/android/game/gamehome/network/gamelauncher/model/user/GetUserResourcesResponse;->userResourceList:Ljava/util/List;
...
.method public synthetic constructor <init>(Ljava/lang/String;Ljava/util/List;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    .line 5
    :cond_0
    invoke-direct {p0, p1, p2}, Lcom/samsung/android/game/gamehome/network/gamelauncher/model/user/GetUserResourcesResponse;-><init>(Ljava/lang/String;Ljava/util/List;)V

    return-void
.end method

.method public static synthetic copy$default(Lcom/samsung/android/game/gamehome/network/gamelauncher/model/user/GetUserResourcesResponse;Ljava/lang/String;Ljava/util/List;ILjava/lang/Object;)Lcom/samsung/android/game/gamehome/network/gamelauncher/model/user/GetUserResourcesResponse;
    .locals 0
    ...
    iget-object p1, p0, Lcom/samsung/android/game/gamehome/network/gamelauncher/model/user/GetUserResourcesResponse;->resultCode:Ljava/lang/String;
    ...
    iget-object p2, p0, Lcom/samsung/android/game/gamehome/network/gamelauncher/model/user/GetUserResourcesResponse;->userResourceList:Ljava/util/List;

    :cond_1
    invoke-virtual {p0, p1, p2}, Lcom/samsung/android/game/gamehome/network/gamelauncher/model/user/GetUserResourcesResponse;->copy(Ljava/lang/String;Ljava/util/List;)Lcom/samsung/android/game/gamehome/network/gamelauncher/model/user/GetUserResourcesResponse;
...
.method public final component1()Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/samsung/android/game/gamehome/network/gamelauncher/model/user/GetUserResourcesResponse;->resultCode:Ljava/lang/String;
...
.method public final component2()Ljava/util/List;
    ...
    iget-object p0, p0, Lcom/samsung/android/game/gamehome/network/gamelauncher/model/user/GetUserResourcesResponse;->userResourceList:Ljava/util/List;

    return-object p0
.end method

.method public final copy(Ljava/lang/String;Ljava/util/List;)Lcom/samsung/android/game/gamehome/network/gamelauncher/model/user/GetUserResourcesResponse;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_0
    instance-of v1, p1, Lcom/samsung/android/game/gamehome/network/gamelauncher/model/user/GetUserResourcesResponse;
    ...
    iget-object v1, p0, Lcom/samsung/android/game/gamehome/network/gamelauncher/model/user/GetUserResourcesResponse;->resultCode:Ljava/lang/String;

    iget-object v3, p1, Lcom/samsung/android/game/gamehome/network/gamelauncher/model/user/GetUserResourcesResponse;->resultCode:Ljava/lang/String;
    ...
    iget-object p1, p1, Lcom/samsung/android/game/gamehome/network/gamelauncher/model/user/GetUserResourcesResponse;->userResourceList:Ljava/util/List;
...
.method public final getUserResourceList()Ljava/util/List;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public hashCode()I
    ...
    iget-object v0, p0, Lcom/samsung/android/game/gamehome/network/gamelauncher/model/user/GetUserResourcesResponse;->resultCode:Ljava/lang/String;
...
.method public toString()Ljava/lang/String;
    ...
    const-string v2, "GetUserResourcesResponse(resultCode="
